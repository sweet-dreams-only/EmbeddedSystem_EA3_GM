 ...
 *     Workspace:  C:/SynergyWorkArea/Working/FrqDepDmpnInrtCmp/autosar
 *     SW-C Type:  Ap_FrqDepDmpnInrtCmp
 *  Generated at:  Mon Aug  8 14:07:14 2016
 *
 ...
 * 08/29/14  13       SB		Anomaly 6259 correction															12390
 * 08/08/16	 14       JK        Updated to FDD v007                                                         EA3#10066
 * 09/25/16  15       JK        Changed the table cal name and default value                                EA3#10501
 */
/**********************************************************************************************************************
...
/* MISRA-C:2004 Rule 8.7: Deviation required for the display and module level variables because of memory map.The rule is suppressed at each line */
...
#define D_FLOATONE_ULS_F32					1.0F
...
/* Display variables */
STATIC volatile VAR(float32, AUTOMATIC) DriverVelocity_MtrRadpS_D_f32; /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) ADDCoef_MtrNmSpRad_D_f32; /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) FDDAttenOut_MtrNm_D_f32;  /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) InertiaCompCalc_MtrNm_D_f32; /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) FiltFreqLUBlnd_RadpS_D_f32; /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) TbarVelFiltVal_HwDegpSec_D_f32; /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) RawDecelGain_Uls_D_f32; /* PRQA S 3218 */

/* Module Internal */
STATIC VAR(float32, AUTOMATIC) PreDecelGain_Uls_M_f32;
STATIC VAR(float32, AUTOMATIC) PrevTbarAng_HwDeg_M_f32; /* PRQA S 3218 */
STATIC VAR(float32, AUTOMATIC) Prev1SclDrvVel_RadpS_M_f32; /* PRQA S 3218 */
STATIC VAR(float32, AUTOMATIC) Prev2SclDrvVel_RadpS_M_f32; /* PRQA S 3218 */
STATIC VAR(float32, AUTOMATIC) Prev1PreAttnComp_MtrNm_M_f32; /* PRQA S 3218 */
STATIC VAR(float32, AUTOMATIC) Prev2PreAttnComp_MtrNm_M_f32; /* PRQA S 3218 */
...
STATIC FUNC(float32, AP_FRQDEPDMPNINRTCMP_CODE) DecelGain( VAR(float32, AUTOMATIC) VehicleLonAccel_KphpS_T_f32, 
															 VAR(float32, AUTOMATIC) CRFMotorVel_MtrRadpS_T_f32,
															 VAR(boolean, AUTOMATIC) BrakePulsationEna_Cnt_T_lgc);
 ...
 *********************************************************************************************************************/
	PreDecelGain_Uls_M_f32 = D_FLOATONE_ULS_F32;
 ...
 *   Boolean Rte_IRead_FrqDepDmpnInrtCmp_Per1_BrakePulsationEna_Cnt_lgc(void)
...
/*
	...
	BrakePulsationEna_Cnt_T_lgc = Rte_IRead_FrqDepDmpnInrtCmp_Per1_BrakePulsationEna_Cnt_lgc();
	...
	DecelGain_Uls_T_f32 = DecelGain( VehicleLonAccel_KphpS_T_f32, CRFMotorVel_MtrRadpS_T_f32,BrakePulsationEna_Cnt_T_lgc);
															 ...
															 VAR(float32, AUTOMATIC) VehicleSpeed_Kph_T_f32 )
{
	...
	VAR(float32, AUTOMATIC) FinStaticFDD_MtrNmSpRad_T_f32;
	VAR(float32, AUTOMATIC) StaticFDD0_MtrNmSpRad_T_f32;
	VAR(float32, AUTOMATIC) StaticFDD1_MtrNmSpRad_T_f32;
	...
	StaticFDD0_MtrNmSpRad_T_f32 = FPM_FixedToFloat_m( IntplVarXY_u16_u16Xu16Y_Cnt(t_DmpADDCoefX_MtrNm_u4p12,
																					t2_FDD_ADDStaticTblY_MtrNmpRadpS_um1p17[0],
																					TableSize_m(t_DmpADDCoefX_MtrNm_u4p12),
																					AbsBaseAssistCmd_MtrNm_T_u4p12), um1p17_T);

	StaticFDD1_MtrNmSpRad_T_f32 = FPM_FixedToFloat_m( IntplVarXY_u16_u16Xu16Y_Cnt(t_DmpADDCoefX_MtrNm_u4p12,
																					t2_FDD_ADDStaticTblY_MtrNmpRadpS_um1p17[1],
																					TableSize_m(t_DmpADDCoefX_MtrNm_u4p12),
																					AbsBaseAssistCmd_MtrNm_T_u4p12), um1p17_T);
	...
	FinStaticFDD_MtrNmSpRad_T_f32  = (StaticFDD1_MtrNmSpRad_T_f32 * RIAstWIRBlnd_MtrNmSpRad_T_f32) + (StaticFDD0_MtrNmSpRad_T_f32 * (D_ONE_ULS_F32 - RIAstWIRBlnd_MtrNmSpRad_T_f32));
	...
	ADDCoefCalc_MtrNmSpRad_T_f32 = (FinRollingFDD_MtrNmSpRad_T_f32 * FDDBlnd_Uls_T_f32) + (FinStaticFDD_MtrNmSpRad_T_f32 * (D_ONE_ULS_F32 - FDDBlnd_Uls_T_f32));
															 ...
															 VAR(boolean, AUTOMATIC) BrakePulsationEna_Cnt_T_lgc)
{
	...
	if(BrakePulsationEna_Cnt_T_lgc == FALSE)
	{
		/* DecelGainDisable */
		DecelGain_Uls_T_f32 = D_FLOATONE_ULS_F32;
	}
