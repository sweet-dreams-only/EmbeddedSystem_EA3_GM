 ...
 *     Workspace:  C:/SynergyWorkArea/Working/PwrLmtFuncCr-czmgrw/PwrLmtFuncCr/autosar
 *     SW-C Type:  Ap_PwrLmtFuncCr
 *  Generated at:  Wed Jun 17 08:32:37 2015
 *
 ...
 * 05/29/15 13        JK        Updated to SF-19B v010:Added logic to divide torque command by				 13412
 * 								number of active inverters, intended to be used for dual inverter systems
*/ 
/**********************************************************************************************************************
...
STATIC VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_SpdAdj_MtrRadpS_M_f32;                             /* PRQA S 3218 */
STATIC VAR(uint32,  AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_VoltageRecoveryTimer_mS_M_u32;                     /* PRQA S 3218 */
STATIC VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_MtrEnvSpd_MtrRadpS_M_f32;                          /* PRQA S 3218 */
STATIC VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_MinStdOpLmt_MtrNm_M_f32;                           /* PRQA S 3218 */
STATIC VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_TrqEnvLmt1_MtrNm_M_f32;							 /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_TrqLmt1_MtrNm_D_f32;                      /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_OPVelOffset_MtrRadpS_D_f32;               /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_TLimitMaxCurr_MtrNm_D_f32;                /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_MinStdOpLmt_MtrNm_D_f32;                  /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_LimitDifference_MtrNm_D_f32;              /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_TrqLmt_Uls_D_f32;                         /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_TrqEnvLmt4_MtrNm_D_f32;                   /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_TrqLmt4_MtrNm_D_f32;                      /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_MtrVelFilt_MtrRadpS_D_f32;                /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_VecuSlewAdj_Volt_M_f32;                   /* PRQA S 3218 */
STATIC volatile VAR(float32, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_CntDisMtrTrqCmdPerInvMRF_MtrNm_D_f32;     /* PRQA S 3218 */
...
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(boolean, AP_PWRLMTFUNCCR_VAR) PwrLmtFuncCr_ThresholdExceeded_Cnt_M_lgc;                       /* PRQA S 3218 */
 ...
 *   Boolean Rte_IRead_PwrLmtFuncCr_Per1_IvtrLoaMtgtnEn_Cnt_lgc(void)
 ...
 *********************************************************************************************************************/
	...
	VAR(uint8,  AUTOMATIC) NumofInverters_Cnt_T_u08;
	VAR(float32, AUTOMATIC) CntDisMtrCmdPerInvMRF_MtrNm_T_f32;
	...
	IvtrLoaMtgtnEn_Cnt_T_lgc = Rte_IRead_PwrLmtFuncCr_Per1_IvtrLoaMtgtnEn_Cnt_lgc();
	...
	/** TrqCmd_scl_Inverter **/
	if((IvtrLoaMtgtnEn_Cnt_T_lgc == TRUE)||(k_PwrLmt_NumofInverters_Cnt_u08 == 1u))
	{
		NumofInverters_Cnt_T_u08 = 1u;
	}
	else
	{
		NumofInverters_Cnt_T_u08 = 2u;
	}
	
	CntDisMtrCmdPerInvMRF_MtrNm_T_f32 = CntDisMtrCmdMRF_MtrNm_T_f32/(float32)NumofInverters_Cnt_T_u08;
	PwrLmtFuncCr_CntDisMtrTrqCmdPerInvMRF_MtrNm_D_f32 = CntDisMtrCmdPerInvMRF_MtrNm_T_f32;
	...
	if (Abs_s16_m(t_MtrEnvTblX_MtrRadpS_s11p4[2]) >= AbsMtrEnvSpd_MtrRadpS_T_u12p4)
	{
		...
		MRFMtrTrq_MtrNm_T_f32= ((float32)SignMtrEnvSpd_Uls_T_s32) * CntDisMtrCmdPerInvMRF_MtrNm_T_f32;
