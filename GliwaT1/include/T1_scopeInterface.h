...
T1_EXTERN void T1_CODE_FAST T1_TraceSync(           T1_tickUint_t volatile const *pTime );
T1_EXTERN void T1_CODE_FAST T1_TraceSyncNoSusp(     T1_tickUint_t volatile const *pTime );
#       define T1_STOP_SEC_CODE_FAST
#       include "T1_MemMap.h"
...
#       endif /* defined T1_32BIT_TRACE_TIME */
#       define T1_TraceSyncFast( pTime_ )                                       \
        T1_TraceSync( pTime_ )
