...
#       define T1_START_SEC_CONST_16
#       include "T1_MemMap.h"
const T1_tick_t         T1_overheadPC[] T1_SEC_CONST_16     = { (T1_tick_t)T1_NS_TO_TICKS_CORE0( T1_OVERHEAD_CORE0_NS ), (T1_tick_t)T1_NS_TO_TICKS_CORE1( T1_OVERHEAD_CORE1_NS ), (T1_tick_t)T1_NS_TO_TICKS_CORE1( T1_OVERHEAD_CORE2_NS ) };
const T1_tick_t         T1_flexOverheadPC[] T1_SEC_CONST_16 = { (T1_tick_t)T1_NS_TO_TICKS_CORE0( T1_FLEX_OVERHEAD_CORE0_NS ), (T1_tick_t)T1_NS_TO_TICKS_CORE1( T1_FLEX_OVERHEAD_CORE1_NS ), (T1_tick_t)T1_NS_TO_TICKS_CORE1( T1_FLEX_OVERHEAD_CORE2_NS ) };
