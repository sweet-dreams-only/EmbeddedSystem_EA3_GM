 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Ap_HOWDetect.c
 *     Workspace:  C:/EA3 Component/HOWDetect/autosar
 *     SW-C Type:  Ap_HOWDetect
 *  Generated at:  Mon Mar  6 15:46:21 2017
 *
 ...
 * 03/03/17	  2       ML		Updated to Design v002														 EA3#14468  
 */
/**********************************************************************************************************************
...
STATIC VAR(float32, AP_HOWDETECT_VAR) HOWDetect_HOWEstAftRateLimiter_Uls_M_f32; /* PRQA S 3218 */
STATIC VAR(float32, AP_HOWDETECT_VAR) HOWDetect_HOWEstAftLimiter_Uls_M_f32; /* PRQA S 3218 */ 
STATIC volatile VAR(float32, AP_HOWDETECT_VAR) HOWDetect_AbsHighFreqTrq_HwNm_D_f32; /* PRQA S 3218 */ 
STATIC volatile VAR(float32, AP_HOWDETECT_VAR) HOWDetect_AbsLowFreqTrq_HwNm_D_f32; /* PRQA S 3218 */ 
...
STATIC CONST(sint16, AP_HOWDETECT_VAR) T_HOWStateValues_Cnt_s15p0[7] = { -3, -2, -1, 0, 1, 2, 3 }; /* PRQA S 3218 */
 ...
 *   Boolean Rte_IRead_HOWDetect_Per1_VehicleSpeedValid_Cnt_lgc(void)
 *   Float Rte_IRead_HOWDetect_Per1_VehicleSpeed_Kph_f32(void)
 *
 * Output Interfaces:
 * ==================
 *   Implicit S/R API:
 ...
 *********************************************************************************************************************/
	...
	VehicleSpeed_Kph_T_f32    = Rte_IRead_HOWDetect_Per1_VehicleSpeed_Kph_f32();
	VehicleSpeedValid_Cnt_T_lgc = Rte_IRead_HOWDetect_Per1_VehicleSpeedValid_Cnt_lgc();
	...
	if( (VehicleSpeed_Kph_T_f32 > k_HOWMinVehSpd_Kph_f32) && (VehicleSpeedValid_Cnt_T_lgc == TRUE) )
	{
