 ...
 *     Workspace:  C:/_Synergy_Projects/Working/ses_dev_ea3/Nhet1CfgAndUse/autosar
 *     SW-C Type:  Cd_Nhet1CfgAndUse
 *  Generated at:  Fri Mar  3 15:09:22 2017
 *
...
*****************************************************************************/
/* Version Control:
 * Date Created:      Thr Jun 11 08:50:22 2015 %
 * %version:          4 %
 * %derived_by:       nz2554 %
 *---------------------------------------------------------------------------------------------------------------------
 * Date      Rev      Author         Change Description                                                        SCR #
 * -------   -------  --------  ---------------------------------------------------------------------------  ----------
 * 06/08/15  1        Yue Zhao      Nhet1 Configuration and Use, implementation of FDD_35B					 EA3#1297
 * 09/28/15  2        Selva         Nhet1 Configuration and Use, implementation of FDD_35B v 0.0.3			 EA3#3474
 * 07/06/16  3		  AJM			Changed the SENTSYNCDELAY delay constant value							 EA3#9383
 * 03/03/17  4        SR            Updated to FDD v005 which adds fault inj pts for DigT1 and DigT2         EA3#14378
 */
/**********************************************************************************************************************
...
#define D_SENTSYNCDELAY_CNT_U32   132524UL
...
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(uint32, CD_NHET1CFGANDUSE_VAR)   Nhet1CfgAndUse_HwTq3PrevPulseCount_Cnt_M_u32; /* PRQA S 3218 */
STATIC VAR(uint32, CD_NHET1CFGANDUSE_VAR)   Nhet1CfgAndUse_HwTq4PrevPulseCount_Cnt_M_u32; /* PRQA S 3218 */
STATIC VAR(float32, CD_NHET1CFGANDUSE_VAR)  Nhet1CfgAndUse_HwTq3Val_HwNm_M_f32; /* PRQA S 3218 */
STATIC VAR(float32, CD_NHET1CFGANDUSE_VAR)  Nhet1CfgAndUse_HwTq4Val_HwNm_M_f32; /* PRQA S 3218 */
...
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(uint8, CD_NHET1CFGANDUSE_VAR) Nhet1CfgAndUse_HwTq3ErrAcc_Cnt_M_u08; /* PRQA S 3218 */
STATIC VAR(uint8, CD_NHET1CFGANDUSE_VAR) Nhet1CfgAndUse_HwTq4ErrAcc_Cnt_M_u08; /* PRQA S 3218 */
STATIC VAR(uint8, CD_NHET1CFGANDUSE_VAR) Nhet1CfgAndUse_HwTq3RollgCntr_Cnt_M_u08; /* PRQA S 3218 */
STATIC VAR(uint8, CD_NHET1CFGANDUSE_VAR) Nhet1CfgAndUse_HwTq4RollgCntr_Cnt_M_u08; /* PRQA S 3218 */
#define NHET1CFGANDUSE_STOP_SEC_VAR_CLEARED_8
#include "MemMap.h" /* PRQA S 5087 */

#define NHET1CFGANDUSE_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(SigQlfr_State_enum, CD_NHET1CFGANDUSE_VAR) Nhet1CfgAndUse_HwTq3Qlfr_Cnt_M_enum; /* PRQA S 3218 */
STATIC VAR(SigQlfr_State_enum, CD_NHET1CFGANDUSE_VAR) Nhet1CfgAndUse_HwTq4Qlfr_Cnt_M_enum; /* PRQA S 3218 */
 ...
 *   Implicit S/R API:
 *   -----------------
 *   SInt8 Rte_IRead_Nhet1CfgAndUse_Per2_HwTq3Polarity_Cnt_s08(void)
 *   SInt8 Rte_IRead_Nhet1CfgAndUse_Per2_HwTq4Polarity_Cnt_s08(void)
 *
 * Output Interfaces:
 * ==================
 *   Implicit S/R API:
 *   -----------------
 *   void Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq3Qlfr_State_enum(SigQlfr_State_enum data)
 *   SigQlfr_State_enum *Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq3Qlfr_State_enum(void)
 *   void Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq3RollgCntr_Cnt_u08(UInt8 data)
 *   UInt8 *Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq3RollgCntr_Cnt_u08(void)
 *   void Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq3Val_HwNm_f32(Float data)
 *   Float *Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq3Val_HwNm_f32(void)
 *   void Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq4Qlfr_State_enum(SigQlfr_State_enum data)
 *   SigQlfr_State_enum *Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq4Qlfr_State_enum(void)
 *   void Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq4RollgCntr_Cnt_u08(UInt8 data)
 *   UInt8 *Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq4RollgCntr_Cnt_u08(void)
 *   void Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq4Val_HwNm_f32(Float data)
 *   Float *Rte_IWriteRef_Nhet1CfgAndUse_Per2_HwTq4Val_HwNm_f32(void)
 *
 ...
 *********************************************************************************************************************/
	...
	/*** Temporary Variables ***/
		/* Module Inputs */
	VAR(sint8, AUTOMATIC)     HwTq3Polarity_Cnt_T_s08;  
	VAR(sint8, AUTOMATIC)     HwTq4Polarity_Cnt_T_s08; 
	VAR(uint32, AUTOMATIC)    NhetHtuSent3Raw_Cnt_T_u32[D_NUMRAWDATA_CNT_U08];
	VAR(uint32, AUTOMATIC)    NhetHtuSent4Raw_Cnt_T_u32[D_NUMRAWDATA_CNT_U08];
	
		/* Module internal */
	VAR(uint8,  AUTOMATIC)    TestOk_Cnt_T_u08;
	VAR(float32,  AUTOMATIC)  HwTq3Raw_Cnt_T_f32;
	VAR(float32,  AUTOMATIC)  HwTq4Raw_Cnt_T_f32;
	...
	HwTq3Polarity_Cnt_T_s08 = Rte_IRead_Nhet1CfgAndUse_Per2_HwTq3Polarity_Cnt_s08();
	HwTq4Polarity_Cnt_T_s08 = Rte_IRead_Nhet1CfgAndUse_Per2_HwTq4Polarity_Cnt_s08();
	
	/* Read N2HET_1 data (Torque_3 sensor SENT data) */
	NhetHtuSent3Raw_Cnt_T_u32[PULSE_MSGCOUNTST]   	= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq1_Cnt_u32[0];
	NhetHtuSent3Raw_Cnt_T_u32[PULSE_SYNC]     		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq1_Cnt_u32[1];
	NhetHtuSent3Raw_Cnt_T_u32[PULSE_STATUS]   		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq1_Cnt_u32[2];
	NhetHtuSent3Raw_Cnt_T_u32[PULSE_D0]       		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq1_Cnt_u32[3];
	NhetHtuSent3Raw_Cnt_T_u32[PULSE_D1]       		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq1_Cnt_u32[4];
	NhetHtuSent3Raw_Cnt_T_u32[PULSE_D2]       		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq1_Cnt_u32[5];
	NhetHtuSent3Raw_Cnt_T_u32[PULSE_CRC]      		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq1_Cnt_u32[6];
	NhetHtuSent3Raw_Cnt_T_u32[PULSE_MSGCOUNTEND] 	= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq1_Cnt_u32[7];

	/* Read N2HET_1 data (Torque_4 sensor SENT data) */
	NhetHtuSent4Raw_Cnt_T_u32[PULSE_MSGCOUNTST]   	= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq2_Cnt_u32[0];
	NhetHtuSent4Raw_Cnt_T_u32[PULSE_SYNC]     		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq2_Cnt_u32[1];
	NhetHtuSent4Raw_Cnt_T_u32[PULSE_STATUS]   		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq2_Cnt_u32[2];
	NhetHtuSent4Raw_Cnt_T_u32[PULSE_D0]       		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq2_Cnt_u32[3];
	NhetHtuSent4Raw_Cnt_T_u32[PULSE_D1]       		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq2_Cnt_u32[4];
	NhetHtuSent4Raw_Cnt_T_u32[PULSE_D2]       		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq2_Cnt_u32[5];
	NhetHtuSent4Raw_Cnt_T_u32[PULSE_CRC]      		= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq2_Cnt_u32[6];
	NhetHtuSent4Raw_Cnt_T_u32[PULSE_MSGCOUNTEND] 	= Nhet1CfgAndUse_HtuDataTrq_Cnt_G_str.HtuDataTrq2_Cnt_u32[7];
	
	
 
	/* -------------------------------- Torque_3 sensor SENT data processing ---------------------------------- */												 													 
	TestOk_Cnt_T_u08 = HwTqProtocolFault( NhetHtuSent3Raw_Cnt_T_u32, &Nhet1CfgAndUse_HwTq3PrevPulseCount_Cnt_M_u32,
											                         &HwTq3Raw_Cnt_T_f32,
											                         &NTCParam_Cnt_T_u08 );	
	
		/* Calculate HandWheel Torque 3 and polarity evaluation; And updates fault accumulator and sets NTC */
	...
	{
		Nhet1CfgAndUse_HwTq3ErrAcc_Cnt_M_u08 = (uint8)DiagPStep_m((uint16)Nhet1CfgAndUse_HwTq3ErrAcc_Cnt_M_u08, Nhet1CfgAndUse_Diag_Cnt_M_str); /* Increment fault accumulator */
		
		if( DiagFailed_m((uint16)Nhet1CfgAndUse_HwTq3ErrAcc_Cnt_M_u08, Nhet1CfgAndUse_Diag_Cnt_M_str) == TRUE ) /* Check accumulator for NTC failed and  signal qualifier failed. */
		{
			Nhet1CfgAndUse_HwTq3Qlfr_Cnt_M_enum = SIGQLFR_FAIL;
			(void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_DigT1OutofRange, NTCParam_Cnt_T_u08, NTC_STATUS_FAILED);
		}
	}
	else  /* When No fault presents */
	{
		/* Calculate HandWheel Torque 3 and polarity evaluation */
		Nhet1CfgAndUse_HwTq3Val_HwNm_M_f32 = ( (HwTq3Raw_Cnt_T_f32 * D_HWTRQSCALE_HWNMPCNT_F32) - D_HWTRQOFFSET_HWNM_F32 ) * (float32)HwTq3Polarity_Cnt_T_s08;
	
		Nhet1CfgAndUse_HwTq3RollgCntr_Cnt_M_u08++; /* Update rolling counter */
		
		Nhet1CfgAndUse_HwTq3ErrAcc_Cnt_M_u08 = (uint8)DiagNStep_m((uint16)Nhet1CfgAndUse_HwTq3ErrAcc_Cnt_M_u08, Nhet1CfgAndUse_Diag_Cnt_M_str); /* Decrement fault accumulator */
		
		if(Nhet1CfgAndUse_HwTq3ErrAcc_Cnt_M_u08 == 0x0U) /* Check accumulator for NTC passed and  signal qualifier passed. */
		{
			Nhet1CfgAndUse_HwTq3Qlfr_Cnt_M_enum = SIGQLFR_PASS;
			(void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_DigT1OutofRange, 0U, NTC_STATUS_PASSED);
		}
	}
		/* ------------------------------------------------------------------------------------------------ */
	/* ----------------------------- ******************************************* ------------------------------ */
	...
	/* -------------------------------- Torque_4 sensor SENT data processing ---------------------------------- */												 													 
	TestOk_Cnt_T_u08 = HwTqProtocolFault( NhetHtuSent4Raw_Cnt_T_u32, &Nhet1CfgAndUse_HwTq4PrevPulseCount_Cnt_M_u32,
											                         &HwTq4Raw_Cnt_T_f32,
											                         &NTCParam_Cnt_T_u08 );	
	
		/* Calculate HandWheel Torque 4 and polarity evaluation; And updates fault accumulator and sets NTC */
		/* Note: FDD says to implement ISOFaultDebounce which is not implemented for EA3.0 */
	if ( TestOk_Cnt_T_u08 == D_TESTNOTOK_CNT_U08 )  /* When fault presents */
	{
		Nhet1CfgAndUse_HwTq4ErrAcc_Cnt_M_u08 = (uint8)DiagPStep_m((uint16)Nhet1CfgAndUse_HwTq4ErrAcc_Cnt_M_u08, Nhet1CfgAndUse_Diag_Cnt_M_str); /* Increment fault accumulator */
		
		if( DiagFailed_m((uint16)Nhet1CfgAndUse_HwTq4ErrAcc_Cnt_M_u08, Nhet1CfgAndUse_Diag_Cnt_M_str) == TRUE ) /* Check accumulator for NTC failed and  signal qualifier failed. */
		{
			Nhet1CfgAndUse_HwTq4Qlfr_Cnt_M_enum = SIGQLFR_FAIL;
			(void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_DigT2OutofRange, NTCParam_Cnt_T_u08, NTC_STATUS_FAILED);
		}
	}
	else  /* When No fault presents */
	{
		/* Calculate HandWheel Torque 4 and polarity evaluation */
		Nhet1CfgAndUse_HwTq4Val_HwNm_M_f32 = ( (HwTq4Raw_Cnt_T_f32 * D_HWTRQSCALE_HWNMPCNT_F32) - D_HWTRQOFFSET_HWNM_F32 ) * (float32)HwTq4Polarity_Cnt_T_s08;
	
		Nhet1CfgAndUse_HwTq4RollgCntr_Cnt_M_u08++; /* Update rolling counter */
		
		Nhet1CfgAndUse_HwTq4ErrAcc_Cnt_M_u08 = (uint8)DiagNStep_m((uint16)Nhet1CfgAndUse_HwTq4ErrAcc_Cnt_M_u08, Nhet1CfgAndUse_Diag_Cnt_M_str); /* Decrement fault accumulator */
		
		if(Nhet1CfgAndUse_HwTq4ErrAcc_Cnt_M_u08 == 0x0U) /* Check accumulator for NTC passed and  signal qualifier passed. */
		{
			Nhet1CfgAndUse_HwTq4Qlfr_Cnt_M_enum = SIGQLFR_PASS;
			(void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_DigT2OutofRange, 0U, NTC_STATUS_PASSED);
		}
	}
		/* ------------------------------------------------------------------------------------------------ */
	/* ----------------------------- ******************************************* ------------------------------ */
    ...
    Nhet1CfgAndUse_HwTq3Val_HwNm_M_f32 = Limit_m(Nhet1CfgAndUse_HwTq3Val_HwNm_M_f32, D_HWTQVALLOWLIMIT_HWNM_F32, D_HWTQVALHIGHLIMIT_HWNM_F32);
	Nhet1CfgAndUse_HwTq4Val_HwNm_M_f32 = Limit_m(Nhet1CfgAndUse_HwTq4Val_HwNm_M_f32, D_HWTQVALLOWLIMIT_HWNM_F32, D_HWTQVALHIGHLIMIT_HWNM_F32);

    #if(STD_ON == BC_NHET1CFGANDUSE_T1FLTINJ)
        Rte_Call_FaultInjection_SCom_FltInjection(&Nhet1CfgAndUse_HwTq3Val_HwNm_M_f32,FLTINJ_DIGHWTRQSENT_T1FAULT);
	#endif
    
    #if(STD_ON == BC_NHET1CFGANDUSE_T2FLTINJ)
        Rte_Call_FaultInjection_SCom_FltInjection(&Nhet1CfgAndUse_HwTq4Val_HwNm_M_f32,FLTINJ_DIGHWTRQSENT_T2FAULT);
	#endif
    
	/* Read RTE Outputs */
	(void) Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq3Qlfr_State_enum(Nhet1CfgAndUse_HwTq3Qlfr_Cnt_M_enum);
    (void) Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq3RollgCntr_Cnt_u08(Nhet1CfgAndUse_HwTq3RollgCntr_Cnt_M_u08);
    (void) Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq3Val_HwNm_f32( Nhet1CfgAndUse_HwTq3Val_HwNm_M_f32 );

    (void) Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq4Qlfr_State_enum(Nhet1CfgAndUse_HwTq4Qlfr_Cnt_M_enum);
    (void) Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq4RollgCntr_Cnt_u08(Nhet1CfgAndUse_HwTq4RollgCntr_Cnt_M_u08);
    (void) Rte_IWrite_Nhet1CfgAndUse_Per2_HwTq4Val_HwNm_f32( Nhet1CfgAndUse_HwTq4Val_HwNm_M_f32 );
...
/*****************************************************************************
  ...
  *              in section 5.1.2.1 of the "35B_Nhet1CfgAndUse.doc" file in the FDD.
