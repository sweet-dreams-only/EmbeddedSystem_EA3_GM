 ...
 *********************************************************************************************************************/
	...
	FinalCurrOutputRampMult_Uls_T_f32 = Limit_m(OutputRampMult_Uls_T_f32,(CurrOutputRampMult_Uls_M_f32 - (k_GainDecSlew_UlspS_f32*D_2MS_SEC_F32)), (CurrOutputRampMult_Uls_M_f32 + (GainIncSlew_UlspS_T_f32*D_2MS_SEC_F32) ));
	/* ENDREQ: SF038A #90 */
	...
	FinalCurrOutputRampMult_Uls_T_f32	= Limit_m(FinalCurrOutputRampMult_Uls_T_f32, D_GAINLOLIMIT_ULS_F32, D_GAINHILIMIT_ULS_F32);		/* Limit Output FinalCurrOutputRampMult */
