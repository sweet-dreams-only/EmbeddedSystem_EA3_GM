 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Ap_HystComp.c
 *     Workspace:  C:/SynergyWorkArea/Working/HystComp/autosar
 *     SW-C Type:  Ap_HystComp
 *  Generated at:  Mon Nov 14 14:40:41 2016
 *
 ...
 *********************************************************************************************************************/
/*****************************************************************************
* Copyright 2011,2016 Nxtr
* Nxtr Confidential
*
* Module File Name: Ap_HystComp.c
* Module Description: Hysteresis Compensation
* Project           : CBD
...
* 11/14/16  27       JK        Updated to FDD ver 009                                                     EA3#12480
*/
/**********************************************************************************************************************
...
/* MISRA-C:2004 Rule 11.4 : This deviation is required for library macro .The rule is suppressed at occurrence. */
...
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(float32, AUTOMATIC) HwTrqLastUsed_HwNm_M_f32; /* PRQA S 3218 */
STATIC VAR(float32, AUTOMATIC) Fraction_Uls_M_f32; /* PRQA S 3218 */
STATIC VAR(float32, AUTOMATIC) RiseX_HwNm_M_f32; /* PRQA S 3218 */
/* Display Variables */
STATIC volatile VAR(float32, AUTOMATIC) CompAvail_HwNm_D_f32; /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) HwTrqFilt_HwNm_D_f32; /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) CoulFric_HwNm_D_f32; /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) PosAvail_HwNm_D_f32; /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) NegAvail_HwNm_D_f32; /* PRQA S 3218 */
STATIC volatile VAR(float32, AUTOMATIC) EffCompTrq_HwNm_D_f32; /* PRQA S 3218 */
#define HYSTCOMP_STOP_SEC_VAR_CLEARED_32
#include "MemMap.h" /* PRQA S 5087 */

#define HYSTCOMP_START_SEC_VAR_CLEARED_16
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(sint16, AUTOMATIC) AstCmdLastUsed_HwNm_M_s8p7; /* PRQA S 3218 */
STATIC volatile VAR(sint16, AUTOMATIC) AssistCmdFilt_HwNm_D_s8p7; /* PRQA S 3218 */
 ...
 *   Float Rte_IRead_HystComp_Per1_InpTqOvrl_HwNm_f32(void)
 ...
 *********************************************************************************************************************/
	...
	VAR(float32, AUTOMATIC) InpTqOvrl_HwNm_T_f32;
	...
	InpTqOvrl_HwNm_T_f32 = Rte_IRead_HystComp_Per1_InpTqOvrl_HwNm_f32();

	HwTrq_HwNm_T_f32 = HwTrq_HwNm_T_f32 + InpTqOvrl_HwNm_T_f32;
 ...
 *********************************************************************************************************************/
/*******************************************************************************************************************
  * Name:        MoreCompensation
  * Description: Corresponds to "MoreCompensation" block in Per1 in FDD
  * Inputs:      TrqChange_HwNm_T_f32
  *              RiseXPtr_HwNm_T_f32
  * Outputs:     RiseY_Uls_T_s1p14
  * Usage Notes: None
  ******************************************************************************************************************/
STATIC INLINE FUNC(sint16, AP_HYSTCOMP_CODE) MoreCompensation(	VAR(float32, AUTOMATIC) TrqChange_HwNm_T_f32,
															CONSTP2VAR(float32, AUTOMATIC, AP_HYSTCOMP_CONST) RiseXPtr_HwNm_T_f32)
...
/*******************************************************************************************************************
  * Name:        LessCompensation
  * Description: Corresponds to "LessCompensation" block in Per1 in FDD
  * Inputs:      TrqChange_HwNm_T_f32
  *              PrevRiseY_Uls_T_f32
  *              RiseXPtr_HwNm_T_f32
...
/*******************************************************************************************************************
  * Name:        MoreCompensation
  * Description: Corresponds to "MoreCompensation" block in Per1 in FDD
  * Inputs:      HwTrqFilt_HwNm_T_f32
  *              AssistCmdFilt_HwNm_T_s8p7
  *              VehSpd_Kph_T_u9p7
  * Outputs:     CompAvail_HwNm_T_f32
  * Usage Notes: None
  ******************************************************************************************************************/
STATIC FUNC(float32, AP_HYSTCOMP_CODE) CalcAvailComp(	VAR(float32, AUTOMATIC) HwTrqFilt_HwNm_T_f32,
														VAR(sint16, AUTOMATIC) AssistCmdFilt_HwNm_T_s8p7,
