...
uint32 _errata_SSWF021_45_both_plls(uint32 count,uint32* retries)
{
	...
	*retries = retries_Cnt_T_u32;
	return failCode_Cnt_T_u32;
}

uint32 _errata_SSWF021_45_pll1( uint32 count,uint32* retries)
{
	uint32 failCode_Cnt_T_u32;
	uint32 retries_Cnt_T_u32;
	uint32 clkCntlSav_Cnt_T_u32;
...
uint32 _errata_SSWF021_45_pll2( uint32 count,uint32* retries)
{
	uint32 failCode_Cnt_T_u32;
	uint32 retries_Cnt_T_u32;
	uint32 clkCntlSav_Cnt_T_u32;
