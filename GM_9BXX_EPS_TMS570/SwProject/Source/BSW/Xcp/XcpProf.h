...
#if defined ( XCP_ENABLE_CALIBRATION_MEM_ACCESS_BY_APPL ) && !defined ( XCP_ENABLE_MEM_ACCESS_BY_APPL )
extern vuint8 ApplXcpCalibrationWrite(MTABYTEPTR addr, vuint8 size, MEMORY_ROM BYTEPTR data);
...
extern void XcpPrintf( MEMORY_ROM vuint8 *str, ... );
      #endif
    #endif
  #endif
#endif
...
/* Used only, if read protection of memory areas is required */
  ...
  #else
extern vuint8 ApplXcpCheckReadAccess( MEMORY_ROM MTABYTEPTR address, vuint16 size );
  #endif
#endif
...
/* Used only, if programming protection of memory areas is required */
  ...
  #else
extern vuint8 ApplXcpCheckProgramAccess( MTABYTEPTR address, vuint8 size );
  #endif
#endif
