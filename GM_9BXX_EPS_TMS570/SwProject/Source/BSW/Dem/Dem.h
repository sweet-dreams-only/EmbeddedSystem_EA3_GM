...
extern CONST(uint8, DEM_CONST)  Dem_NeedDemLibVersion_SW_02_16_xx;                                /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#define DIAG_ASRDEM_VECTOR_VERSION              0x0216u
#define DIAG_ASRDEM_VECTOR_RELEASE_VERSION      0x02u
...
#define DEM_APIID_INTERNAL                          0xE7    /* 231 */
#define DEM_UPDATEINDICATORSTATES_APIID             (DEM_APIID_INTERNAL+0)  /* 0xE7: update status of an indicator */
#define DEM_UPDATEEXTENDEDRECORD_APIID              (DEM_APIID_INTERNAL+9)  /* 0xF0 */
#define DEM_UPDATESNAPSHOTRECORD_APIID              (DEM_APIID_INTERNAL+10) /* 0xF1 */
#define DEM_MEMMOVE_APIID                           (DEM_APIID_INTERNAL+11) /* 0xF2 */
#define DEM_UPDATEDTCINPRIM_NOTACT2ACT_APIID        (DEM_APIID_INTERNAL+12) /* 0xF3 */
#define DEM_DELETEDTCINCHRONOSTACK_APIID            (DEM_APIID_INTERNAL+13) /* 0xF4 */
#define DEM_GETOFFSETSNAPSHOTRECORDNTH_APIID        (DEM_APIID_INTERNAL+14) /* 0xF5 */
#define DEM_GETMOSTRECENTSNAPSHOTINDEX_APIID        (DEM_APIID_INTERNAL+15) /* 0xF6 */
#define DEM_CLEARSINGLEEVENT_APIID                  (DEM_APIID_INTERNAL+16) /* 0xF7 */
#define DEM_UPDATEDTCINPRIM_ACT2NOTACT_APIID        (DEM_APIID_INTERNAL+17) /* 0xF8 */
#define DEM_UPDATEUSERDATARECORD_APIID              (DEM_APIID_INTERNAL+18) /* 0xF9 */
#define DEM_CALCNEWDEBOUNCETIMERSLOTVAL_APIID       (DEM_APIID_INTERNAL+22) /* 0xFD */
#define DEM_INITDIAGNOSTICVARIANT_APIID             (DEM_APIID_INTERNAL+23) /* 0xFE */
...
#include "MemMap.h"                                                                               /* PRQA S 5087 */ /* MD_MSR_19.1 */ 
extern VAR(uint32, DEM_VAR)  Dem_ActiveVariant;                                                   /* PRQA S 0850 */ /* MD_MSR_19.8 */
