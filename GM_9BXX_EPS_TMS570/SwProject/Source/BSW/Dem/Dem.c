 ...
 *- Dean Martinovic               Dmc           Vctr Informatik GmbH
 *  -------------------------------------------------------------------------------------------------------------------
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
 ...
 *- 02.16.02  2012-08-30  Ade    ESCAN00061088  Incorrect indicator status after diagnostic service ClearSingleDtc
 */
/*****************************************************************************************************************/ /**
 *
...
#if (  (DIAG_ASRDEM_VECTOR_VERSION         != 0x0216u) \
    || (DIAG_ASRDEM_VECTOR_RELEASE_VERSION != 0x02u)  )
  #error "Vendor specific version numbers of Dem.c and Dem.h are inconsistent"
#endif


/* Automatic version checks removed, see ESCAN00051740 */
/* AR3-F1155 - Version check for StandardTypes (Std_Types.h) */
/* BSW004: AUTOSAR version check - DEM requires datatype 'Std_VersionInfoType' with element 'instanceID' - supported Std_Types versions are: */
/* Specification 1.3.0        is part of AUTOSAR Release R3.0 */
/* Specification 1.2.1 [sic!] is part of AUTOSAR Release R3.1 Rev 0001-004 */
...
/* BSW004: AUTOSAR version check - DEM requires API Det_ReportError() - supported DET versions are: */
/* Specification 2.0.x is part of AUTOSAR Release R2.0 */
/* Specification 2.1.x is part of AUTOSAR Release R2.1 */
/* Specification 2.2.x is part of AUTOSAR Release R3.0, R3.1 */

/* AR3-F1155 - Version check for FiM */
/* BSW004: AUTOSAR version check - DEM requires API Fim_DemTriggerOnEventStatus() - supported FiM versions are: */
/* Specification 1.0.x is part of AUTOSAR Release R2.0 */
/* Specification 1.1.x is part of AUTOSAR Release R2.1 */
/* Specification 1.2.x is part of AUTOSAR Release R3.0 */
/* Specification 1.3.x is part of AUTOSAR Release R3.1 */

/* AR3-F1155 - Version check for NvM */
/* BSW004: AUTOSAR version check - DEM requires API NvM_SetRamBlockStatus() - supported NvM versions are: */
/* Specification 2.1.x is part of AUTOSAR Release R2.0, R2.1 */
/* Specification 2.2.x is part of AUTOSAR Release R3.0 Rev 0001-006 */
/* Specification 2.3.x is part of AUTOSAR Release R3.0 Rev 7, R3.1 */

/* AR3-F1155 - Version check for RTE */
/* BSW004: AUTOSAR version check - DEM requires type definitions from RTE via Rte_Types.h - supported RTE versions are: */
/* Specification 2.0.x is part of AUTOSAR Release R3.0 */
/* Specification 2.1.x is part of AUTOSAR Release R3.0 Rev 0004 */
/* Specification 2.2.x is part of AUTOSAR Release R3.0 Rev 0006, R3.1 Rev 0004 */
/* Specification 2.3.x is part of AUTOSAR Release R3.0 Rev 7,    R3.1 Rev 5 */
...
# if (  (DIAG_ASRDEM_GENTOOL_GENY_MAJOR_VERSION != 0x03u) \
     ||((DIAG_ASRDEM_GENTOOL_GENY_MINOR_VERSION != 0x10u) && (DIAG_ASRDEM_GENTOOL_GENY_PATCH_VERSION != 0xFFu)) \
     ||((DIAG_ASRDEM_GENTOOL_GENY_MINOR_VERSION != 0x09) && (DIAG_ASRDEM_GENTOOL_GENY_PATCH_VERSION == 0xFFu)) ) 
  #error "Version check in Dem.c failed! Requires Gentool GENy (Diag_AsrDem.dll) in version 3.10.xx"
# endif
#endif
...
#define DEM_IS_CHANGED_TEST_FAILED( Lhs, Rhs )                    ((((Lhs) ^ (Rhs)) & (1u << 0)) != 0)                            /* PRQA S 3453 */ /* MD_MSR_19.7 */
#define DEM_SET_BIT_TEST_FAILED( EventId )                        do { Dem_DtcStatusBytePtr[(EventId)] |= (1u << 0); } while (0)
...
#define DEM_SET_BIT_CONFIRMED_DTC( EventId )                      do { Dem_DtcStatusBytePtr[(EventId)] |= (1u << 3); } while (0)
...
STATIC FUNC(void, DEM_CODE) Dem_CalculateIndicatorStates( void );                                                         /* PRQA S 0850 */ /* MD_MSR_19.8 */
STATIC FUNC(void, DEM_CODE) Dem_UpdateIndicatorStates( Dem_EventIdType EventId, boolean IsEventFailed );                  /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
STATIC FUNC(Dem_AQElementTypePtr, DEM_CODE) Dem_AQPeek( uint16 relIndex );                                                /* PRQA S 0850 */ /* MD_MSR_19.8 */
STATIC FUNC(Dem_AQElementTypePtr, DEM_CODE) Dem_AQPeekAbs(uint16 absIndex);                                               /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *    Dem_Lcfg.obj : error LNK2001: unresolved external symbol _Dem_NeedDemLibVersion_SW_02_16_xx
 */
# define DEM_START_SEC_CONST_8BIT
# include "MemMap.h"                                                                                                      /* PRQA S 5087 */ /* MD_MSR_19.1 */  
CONST(uint8, DEM_CONST)  Dem_NeedDemLibVersion_SW_02_16_xx = 0;                                                           /* PRQA S 0850 */ /* MD_MSR_19.8 */
  ...
  )
{
  ...
  if ((Dem_InitializationStatus == DEM_IsEnabledAndRunning) || (Dem_InitializationStatus == DEM_IsEnabled))
  {
    ...
    /* With ISO14229-1/UDS-Draft 2011 version, there are additional severity bits defined. Remove the new, unsupported bits */
    DTCSeverity &= (Dem_DTCSeverityType) ((DEM_SEVERITY_MAINTENANCE_ONLY) | (DEM_SEVERITY_CHECK_AT_NEXT_HALT) | (DEM_SEVERITY_CHECK_IMMEDIATELY));
  ...
  )
{
  ...
  /* Enter Critical ========================================================== */
  Dem_EnterCritical();
  /* Initialize all indicator counters */
  {
    uint16_least indicatorId;
    for (indicatorId = 0; indicatorId < Dem_NumberOfIndicators; ++indicatorId)
    {
      *DemCfg_GetIndicatorCounterPtr((Dem_IndicatorIdType)indicatorId, DEM_INDICATOR_BLINKING)   = 0x0000u;
      *DemCfg_GetIndicatorCounterPtr((Dem_IndicatorIdType)indicatorId, DEM_INDICATOR_CONTINUOUS) = 0x0000u;
    }
  }
  /* Leave Critical ========================================================== */
  Dem_LeaveCritical();
...
#endif  /* DEM_SUPPORT_VARIANT_HANDLING */
#if (DEM_SUPPORT_VARIANT_HANDLING == STD_ON) || (DEM_SUPPORT_MULTIPLE_CONFIG == STD_ON)
  Dem_ActiveVariant = 0xFFFFFFFFuL;
#endif  /* DEM_SUPPORT_VARIANT_HANDLING || DEM_SUPPORT_MULTIPLE_CONFIG */
}
...
#endif
  /* Restore indicator counters from NVRAM data */
  Dem_CalculateIndicatorStates();
  ...
  )
{
     ...
     )
  {
    ...
    /* internal events must not be considered */
    ...
    if ((SsRecBufIdx + SsRecDataSize) <= DemCfg_GetMaxSnapshotRecordSize())
    {
      ...
      { /* find correct function for given DID */
        ...
        { /* call the configured function Xxx_DemGetDataValueByDataIdentifier{DataId}() to fill this DID's data record */
          ...
          CDD_DemIdSnapshot_Cnt_G_u08 = EventId; /*<<=====================================  DD added this line to capture EventId for Snapshot data PID $C000 */
  ...
  )
{
    ...
    || ((DemCfg_GetDTCGroupKind(EventId) == 0) && (Dem_StatusUpdate != 0)))   /* or if internal event: check !DisableEventStatusUpdate(ALL) */
  {
    ...
    { /* there is a change */
      ...
      /* Update indicator status before notifiction to the application, in case it calls 
      ** GetIndicatorStatus from within the callback */

      /* As bit 'testFailed' was set before, update indicators of this event */
      Dem_UpdateIndicatorStates(EventId, FALSE);
  ...
  )
{
  ...
  if (CycleState == DEM_CYCLE_STATE_START)
  {
    ...
    /* start with topmost element, so aging will not invalidate loop index 'chronoIndex' */
    chronoIndex = *Dem_ChronoPriMemUsedPtr;
    while (chronoIndex > 0)
    {
      chronoIndex--;
  ...
  )
{
    ...
    )
  {
    ...
    case DEM_EVENT_STATUS_FAILED :
      ...
      else if (DEM_IS_UNSET_STORED_DTC(EventId) != FALSE)
    ...
    { /* there is a change */
      ...
      /* Update indicator status before notification to the application, in case it calls 
      ** GetIndicatorStatus from the callback */

      /* When bit 'testFailed' has been changed, update indicators of this event (dependend on new state) */
      if(DEM_IS_CHANGED_TEST_FAILED(lDtcStatusByte, Dem_DtcStatusBytePtr[EventId]))
      { /* E.g. bit 'testFailed' has been changed from '0' to '1' -> IndicatorCounter is incremented */
        Dem_UpdateIndicatorStates(EventId, (boolean) DEM_IS_BIT_SET_TEST_FAILED(EventId));
      }
...
# endif /* DEM_SUPPORT_VARIANT_HANDLING || DEM_SUPPORT_MULTIPLE_CONFIG */
      {
        ...
        {
          success = Dem_DoSetEventStatus(EventId, DEM_EVENT_STATUS_FAILED);
        }
        else
        {
          success = Dem_DoSetEventStatus(EventId, DEM_EVENT_STATUS_PASSED);
        }
        if (success != E_OK)
        {
          /* Reset the FDC to 0, when the event can not be set, to permit future (re-)starts of the timer. */
          /* Do not keep the debounce running. Rationale: a "normal" SetEvent must also be externally re-triggered, when it's currently not possible. */
          Dem_FaultDetectionCounterPtr[EventId] = 0;
        }
      ...
      *  Ignore 'passed' events to avoid Buffer overflow [Dem107] */
      ...
      { /* OS is running - we use standard critical section handling here */
        ...
        */
        ...
        { /* put 'failed' and 'passed' event into queue, if there is space for event + n times StartOperationCycle()  */
          if (Dem_AQUsed() < (uint16) Dem_ReportErrorBufferSize)
          {
            /* Enter Critical ========================================================== */
            Dem_EnterCritical();
                       ...
                       )
{
  ...
  Dem_IndicatorStatusType  resultIndicatorStatus = DEM_INDICATOR_OFF;

#if (DEM_DEV_ERROR_DETECT == STD_ON)
  if (Dem_IndicatorStatus == NULL_PTR)
  {
    Dem_DetReportError(DEM_GETINDICATORSTATUS_APIID, DEM_E_PARAM_ADDRESS);
  }
  else
#endif  /* DEM_DEV_ERROR_DETECT */
    if ((Dem_InitializationStatus == DEM_IsEnabledAndRunning) || (Dem_InitializationStatus == DEM_IsEnabled))
    {
      if (Dem_IndicatorId >= Dem_NumberOfIndicators)
      { /* Requested IndicatorId is not configured */
#if (DEM_DEV_ERROR_DETECT == STD_ON)
        Dem_DetReportError(DEM_GETINDICATORSTATUS_APIID, DEM_E_PARAM_CONFIG);
#endif  /* DEM_DEV_ERROR_DETECT */
      }
      else
      { /* Requested IndicatorId is configured */

        /* Enter Critical ========================================================== */
        Dem_EnterCritical();
        if ((*DemCfg_GetIndicatorCounterPtr(Dem_IndicatorId, DEM_INDICATOR_BLINKING))>0)
        { /* At least one of the events which has configured the requested indicator with 'blinking' is 'failed' */
          resultIndicatorStatus |= DEM_INDICATOR_BLINKING;
        }
        if ((*DemCfg_GetIndicatorCounterPtr(Dem_IndicatorId, DEM_INDICATOR_CONTINUOUS))>0)
        { /* At least one of the events which has configured the requested indicator with 'continuous' is 'failed' */
          resultIndicatorStatus |= DEM_INDICATOR_CONTINUOUS;
        }
        /* Leave Critical ========================================================== */
        Dem_LeaveCritical();
...
*   Dem_CalculateIndicatorStates
**********************************************************************************************************************/
/** Calculate states of all indicators based on event status.
*  This function shall be used to calculate all indicator states derived from all event states as a summary of all
*  assigned events.
* \note        SYNC/ASYNC   Synchronous
* \note        REENTRANCY   Non Reentrant
* \note        CALLED BY    Internal from Dem_Init()
                             ...
                             )
{
  ...
  /* Iterate over events and get their indicator status */
  for (EventId = DemCfg_GetMaxCountOfEventId(); EventId > 0; --EventId)
  {
# if (DEM_SUPPORT_VARIANT_HANDLING == STD_ON) || (DEM_SUPPORT_MULTIPLE_CONFIG == STD_ON)
    if (FALSE != Dem_IsInActiveVariant(EventId))
# endif  /* DEM_SUPPORT_VARIANT_HANDLING || DEM_SUPPORT_MULTIPLE_CONFIG */
    {
      /* Check, if the indicator has to be activated for this event */
      if (DEM_IS_BIT_SET_TEST_FAILED(EventId))
      {
        /* Increment indicator counter */
        Dem_UpdateIndicatorStates(EventId, TRUE);
      }
      /* else: Event is not failed - indicator counter remains unchanged */
    }
  }
}
...
/**********************************************************************************************************************
*   Dem_UpdateIndicatorStates
**********************************************************************************************************************/
/** Update status of an indicator.
*  This function shall be used to update all indicator counters of this event. It must only be 
*  called on status changes of the relevant 'testFailed' bit.
*  By the value of argument 'IsEventFailed' the caller decides, whether the counters are in- or decremented:
*-   TRUE:     Counters are incremented (testFailed 0->1)
*-   FALSE:    Counters are decremented (testFailed 1->0)
* \note        SERVICE ID   0xE7
* \note        SYNC/ASYNC   Synchronous
* \note        REENTRANCY   Reentrant
* \note        CALLED BY    Internal from Dem_CalculateIndicatorStates(), Dem_DoSetOperationCycleState(), 
*                           Dem_DoSetEventStatus(), Dem_ResetEventStatus(), Dem_DoClearSingleEvent(), 
*                           Dem_MainFunction() with 'clear all' 
* \param[in]   EventId           Event to udpate all related indicator counters for
* \param[in]   IsEventFailed TRUE:  Indicator counters will be incremented
*                            FALSE: Indicator counters will be decremented
*********************************************************************************************************************/
STATIC FUNC(void, DEM_CODE)                                                    /* PRQA S 0850 */ /* MD_MSR_19.8 */
Dem_UpdateIndicatorStates(
                          Dem_EventIdType   EventId,
                          boolean           IsEventFailed
                          )
{
  uint16_least             indicatorIdCount;            /* configured number of IndicatorIds for the event */
  uint16                   indicatorIndex;              /* index to IndicatorId and IndicatorStatus */
  Dem_IndicatorIdType      indicatorId;                 /* IndicatorId to update */
  Dem_IndicatorStatusType  indicatorStatus;             /* IndicatorStatus to update */

  indicatorIndex  = DemCfg_GetIndicatorIndex(EventId);

  if ( FALSE == IsEventFailed )
  { /* 'testFailed' bit of event has been changed to 0 ('passed'): Indicator counter value will be decremented */
    for (indicatorIdCount = DemCfg_GetCountOfIndicatorIds(EventId); indicatorIdCount > 0; --indicatorIdCount)
    {
      indicatorId     = DemCfg_GetIndicatorId(indicatorIndex);
      indicatorStatus = DemCfg_GetIndicatorStatusType(indicatorIndex);

#if (DEM_DEV_ERROR_DETECT == STD_ON)
      if ((DEM_INDICATOR_BLINKING   != indicatorStatus /* status == blinking? */   )
        &&(DEM_INDICATOR_CONTINUOUS != indicatorStatus /* status == continuous? */ ))
      { /* Invalid generated state of indicator in Dem_IndicatorStatusTable[] */
        Dem_DetReportError(DEM_UPDATEINDICATORSTATES_APIID, DEM_E_PARAM_DATA);
      }
      else
#endif  /* DEM_DEV_ERROR_DETECT */
      { /* Status is valid */
        ...
        Dem_EnterCritical();
#if (DEM_DEV_ERROR_DETECT == STD_ON)
        if (*DemCfg_GetIndicatorCounterPtr(indicatorId, indicatorStatus) == (Dem_EventIdType)0x0000u)
        { /* Something is completely wrong - indicator counter underflow */
          Dem_DetReportError(DEM_UPDATEINDICATORSTATES_APIID, DEM_E_INVALIDSTATE);
        }
        else
#endif  /* DEM_DEV_ERROR_DETECT */
        { /* Counter is in valid range */
          --(*DemCfg_GetIndicatorCounterPtr(indicatorId, indicatorStatus));
        }
        /* Leave Critical ========================================================== */
        Dem_LeaveCritical();
      }
  ...
  else  /* FALSE != IsEventFailed */
  { /* 'testFailed' bit of event has been changed to 1 ('failed'): Indicator counter value will be incremented */
    for (indicatorIdCount = DemCfg_GetCountOfIndicatorIds(EventId); indicatorIdCount > 0; --indicatorIdCount)
    {
      indicatorId     = DemCfg_GetIndicatorId(indicatorIndex);
      indicatorStatus = DemCfg_GetIndicatorStatusType(indicatorIndex);
      ...
      { /* Status is valid */
        ...
        Dem_EnterCritical();
#if (DEM_DEV_ERROR_DETECT == STD_ON)
        if (*DemCfg_GetIndicatorCounterPtr(indicatorId, indicatorStatus) == (Dem_EventIdType)0xFFFFu)
        { /* Something is completely wrong - indicator counter overflow */
          Dem_DetReportError(DEM_UPDATEINDICATORSTATES_APIID, DEM_E_INVALIDSTATE);
        }
        else
#endif  /* DEM_DEV_ERROR_DETECT */
  ...
  if ((Dem_InitializationStatus == DEM_IsEnabledAndRunning) || (Dem_InitializationStatus == DEM_IsEnabled))
  {
    ...
    { /* valid DTC Number */
      ...
      /* Extended data is event specific, some records are available only if a primary memory entry exists. */
      {
        ...
        recordIndexLast = recordIndex + (uint16_least) DemCfg_GetCountOfCurrentExtendedRecord(EventId);    /* last + 1 */
  ...
  )
{
  ...
  { /* there is a change */
    ...
    /* Update indicators before notification to the application, in case it calls
    ** GetIndicatorStatus from the callback */

    /* When bit 'testFailed' was set before, update indicators of this event */
    if (DEM_IS_CHANGED_TEST_FAILED(lDtcStatusByte, Dem_DtcStatusBytePtr[EventId]))
    { /* Bit 'testFailed' has been changed from '1' to '0' */
      Dem_UpdateIndicatorStates(EventId, FALSE);
    }
