...
/**********************************************************************************************************************
 *  IoHwAb_SetFetFlt2ClkABC
 **********************************************************************************************************************
 *! \brief      This is the OP_SET function for the CAL signal FetFlt2ClkABC.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetFetFlt2ClkABC
(
...
/**********************************************************************************************************************
 *  IoHwAb_GetFetFlt2ClkABC
 **********************************************************************************************************************
 *! \brief      This is the OP_GET for the CAL signal FetFlt2ClkABC.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetFetFlt2ClkABC
(
    P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal
)
{
...
/**********************************************************************************************************************
 *  IoHwAb_GetFetFlt1DataABC
 **********************************************************************************************************************
 *! \brief      This is the OP_GET for the CAL signal FetFlt1DataABC.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetFetFlt1DataABC
(
    P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal
)
{
...
/**********************************************************************************************************************
 *  IoHwAb_SetSysFault2A
 **********************************************************************************************************************
 *! \brief      This is the OP_SET function for the CAL signal SysFault2A.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetSysFault2A
(
    IoHwAb_BoolType signal
)
{
...
/**********************************************************************************************************************
 *  IoHwAb_GetSysFault2A
 **********************************************************************************************************************
 *! \brief      This is the OP_GET for the CAL signal SysFault2A.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetSysFault2A
(
    P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal
)
{
...
/**********************************************************************************************************************
 *  IoHwAb_SetFetDrvResetABC
 **********************************************************************************************************************
 *! \brief      This is the OP_SET function for the CAL signal FetDrvResetABC.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetFetDrvResetABC
(
    IoHwAb_BoolType signal
)
{
...
/**********************************************************************************************************************
 *  IoHwAb_GetFetDrvResetABC
 **********************************************************************************************************************
 *! \brief      This is the OP_GET for the CAL signal FetDrvResetABC.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetFetDrvResetABC
(
    P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal
)
{
...
/**********************************************************************************************************************
 *  IoHwAb_SetFetDrvResetDEF
 **********************************************************************************************************************
 *! \brief      This is the OP_SET function for the CAL signal FetDrvResetDEF.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetFetDrvResetDEF
(
    IoHwAb_BoolType signal
)
{

    Dio_WriteChannel(GIOB2, (Dio_LevelType)signal);
...
/**********************************************************************************************************************
 *  IoHwAb_GetFetDrvResetDEF
 **********************************************************************************************************************
 *! \brief      This is the OP_GET for the CAL signal FetDrvResetDEF.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetFetDrvResetDEF
(
    P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal
)
{
    ...
    *signal = (IoHwAb_BoolType)Dio_ReadChannel(GIOB2);
...
/**********************************************************************************************************************
 *  IoHwAb_SetSysFault2B
 **********************************************************************************************************************
 *! \brief      This is the OP_SET function for the CAL signal SysFault2B.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetSysFault2B
(
    IoHwAb_BoolType signal
)
{

    Dio_WriteChannel(GIOA0, (Dio_LevelType)signal);
...
/**********************************************************************************************************************
 *  IoHwAb_GetSysFault2B
 **********************************************************************************************************************
 *! \brief      This is the OP_GET for the CAL signal SysFault2B.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetSysFault2B
(
    P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal
)
{
    ...
    *signal = (IoHwAb_BoolType)Dio_ReadChannel(GIOA0);
...
/**********************************************************************************************************************
 *  IoHwAb_GetFetFlt1DataDEF
 **********************************************************************************************************************
 *! \brief      This is the OP_GET for the CAL signal FetFlt1DataDEF.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetFetFlt1DataDEF
(
    P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal
)
{
    ...
    *signal = (IoHwAb_BoolType)Dio_ReadChannel(GIOB0);
...
/**********************************************************************************************************************
 *  IoHwAb_SetFetFlt2ClkDEF
 **********************************************************************************************************************
 *! \brief      This is the OP_SET function for the CAL signal FetFlt2ClkDEF.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetFetFlt2ClkDEF
(
    IoHwAb_BoolType signal
)
{

    Dio_WriteChannel(GIOB1, (Dio_LevelType)signal);
...
/**********************************************************************************************************************
 *  IoHwAb_GetFetFlt2ClkDEF
 **********************************************************************************************************************
 *! \brief      This is the OP_GET for the CAL signal FetFlt2ClkDEF.
 *  \param[in]  in                      IoHwAb_BoolType signal
 *  \retval     E_OK - success
 *********************************************************************************************************************/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetFetFlt2ClkDEF
(
    P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal
)
{
    ...
    *signal = (IoHwAb_BoolType)Dio_ReadChannel(GIOB1);
