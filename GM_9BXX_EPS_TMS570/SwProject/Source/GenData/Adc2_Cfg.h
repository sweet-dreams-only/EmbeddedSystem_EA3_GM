...
#define D_ADC2NUMG1CH_CNT_U08	8U              /* Number of channels sampled (e.g. number of bits set in D_ADC2G1CH_CNT_U32) */
#define D_ADC2G1CH_CNT_U32		0xE187U         /* Channel configuration - Value founded in FDD SelRegister cell */
#define D_ADC2G1BUFSZ_CNT_U08	8U              /* Number of results allocated in ADC RAM, must be even */
...
#define D_PHASECCHN_CNT_U16           2U
#define D_SYSCBATTSWITCHED2_CNT_U16   3U
#define D_ADC2DUMMYREAD_CNT_U16       4U
#define D_SYSCBATTSWITCHED1_CNT_U16   5U
#define D_SYSCT1ADC_CNT_U16           6U
#define D_SYSCT2ADC_CNT_U16           7U
