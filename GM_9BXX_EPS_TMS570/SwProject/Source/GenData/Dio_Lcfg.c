...
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupGioA = { 0x07002F0E, 0x00000001, 0 };
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupGioB = { 0x08002F16, 0x00000001, 0 };
/*</DIO_CFG_GROUP_LIST>*/
