...
V_MEMRAM0 V_MEMRAM1 _c_PPEI_Hybrid_General_Status_3_HS_buf V_MEMRAM2 PPEI_Hybrid_General_Status_3_HS;
...
V_MEMRAM0 V_MEMRAM1 _c_PPEI_Vehicle_Speed_and_Distance_buf V_MEMRAM2 PPEI_Vehicle_Speed_and_Distance;
V_MEMRAM0 V_MEMRAM1 _c_NonDriven_Wheel_Grnd_Velocity_HS_buf V_MEMRAM2 NonDriven_Wheel_Grnd_Velocity_HS;
V_MEMRAM0 V_MEMRAM1 _c_PPEI_Engine_General_Status_4_buf V_MEMRAM2 PPEI_Engine_General_Status_4;
...
V_MEMRAM0 V_MEMRAM1 _c_PPEI_Driven_Whl_Rotational_Stat_buf V_MEMRAM2 PPEI_Driven_Whl_Rotational_Stat;
...
V_MEMRAM0 V_MEMRAM1 _c_EngCltTmpGroup_buf V_MEMRAM2 EngCltTmpGroup;
...
V_MEMRAM0 V_MEMRAM1 _c_VehSpdAvgDrvnGroup_0_buf V_MEMRAM2 VehSpdAvgDrvnGroup_0;
V_MEMRAM0 V_MEMRAM1 _c_DistRollCntAvgDrvnGroup_buf V_MEMRAM2 DistRollCntAvgDrvnGroup;
V_MEMRAM0 V_MEMRAM1 _c_VehSpdAvgNDrvnGroup_buf V_MEMRAM2 VehSpdAvgNDrvnGroup;
V_MEMRAM0 V_MEMRAM1 _c_DstRolCntAvgNonDrvnGroup_buf V_MEMRAM2 DstRolCntAvgNonDrvnGroup;
...
V_MEMRAM0 V_MEMRAM1 _c_ActAxleTrqGroup_buf V_MEMRAM2 ActAxleTrqGroup;
V_MEMRAM0 V_MEMRAM1 _c_WhlRotatStatLftDrvn_buf V_MEMRAM2 WhlRotatStatLftDrvn;
V_MEMRAM0 V_MEMRAM1 _c_WhlRotatStatRtDrvn_buf V_MEMRAM2 WhlRotatStatRtDrvn;
...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <C:\Synergy\GM_C1XX_EPS_TMS570-dzxvzg\GM_C1XX_EPS_TMS570\SwProject\Source\_GenData\drv_par.c> is different. Please check time and date of generated files!"
  #endif
#else
  #error "The magic number is not defined in the generated file <C:\Synergy\GM_C1XX_EPS_TMS570-dzxvzg\GM_C1XX_EPS_TMS570\SwProject\Source\_GenData\drv_par.c> "
