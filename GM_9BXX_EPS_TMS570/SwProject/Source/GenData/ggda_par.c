...
V_MEMROM0 V_MEMROM1 GgdaTpConfigType V_MEMROM2 ggdaTpConfig[kGgdaNumContexts] = 
{
  ...
  {
    TpTxHandleGgdaChannel1, 
    TpRxHandleGgdaChannel1
  }
};
...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <C:\CMSynergy_Projects\Chrysler_C1xx\Chrysler_LWR_EPS_TMS570\SwProject\Source\_GenData\ggda_par.c> is different. Please check time and date of generated files!"
  #endif
#else
  #error "The magic number is not defined in the generated file <C:\CMSynergy_Projects\Chrysler_C1xx\Chrysler_LWR_EPS_TMS570\SwProject\Source\_GenData\ggda_par.c> "
