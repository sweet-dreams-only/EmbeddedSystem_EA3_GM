...
# define Rte_TypeDef_CustDataType
typedef UInt32 CustDataType[6];

# define Rte_TypeDef_CustReadCmplType
typedef Boolean CustReadCmplType[6];

# define Rte_TypeDef_DTCStsFlg
typedef Boolean DTCStsFlg[40];

# define Rte_TypeDef_DT_Array3_f32
typedef Float DT_Array3_f32[3];

# define Rte_TypeDef_DT_MotMeclPosnCoeffTbl_f32
typedef Float DT_MotMeclPosnCoeffTbl_f32[26];

# define Rte_TypeDef_DT_SinTanLkpTbl_f32
typedef Float DT_SinTanLkpTbl_f32[193];

# define Rte_TypeDef_MotPosnBackEmfData
typedef UInt16 MotPosnBackEmfData[2];

# define Rte_TypeDef_MtrPos3SinCos_EOLwithCRC
typedef UInt16 MtrPos3SinCos_EOLwithCRC[6];

# define Rte_TypeDef_NvM_DestPtr
typedef UInt8 NvM_DestPtr[65535];

# define Rte_TypeDef_AnaHwTrqScale_Datatype
typedef struct
{
  Float HwTrqScale_VoltsPerDeg_f32;
  Boolean HwTrqScalePerf_Cnt_lgc;
} AnaHwTrqScale_Datatype;

# define Rte_TypeDef_AnaHwTrqTrim_Datatype
typedef struct
{
  Float T1Trim_Volts_f32;
  Float T2Trim_Volts_f32;
  Boolean HwTrqTrimPerf_Cnt_lgc;
} AnaHwTrqTrim_Datatype;
...
# define Rte_TypeDef_MtrPos3SinCos_Str
typedef struct
{
...
# define Rte_TypeDef_PhaseCurrCal3Phs_DataType
typedef struct
{
...
# define Rte_TypeDef_TSMit_Disable_Type
typedef struct
{
  Boolean GainLearningDisable_Cnt_lgc;
  Boolean FunctionDisable_Cnt_lgc;
} TSMit_Disable_Type;

# define Rte_TypeDef_TSMit_Gain_Type
typedef struct
{
  Float PosTransGainLongTerm_HwNmpTransNm_f32;
  Float NegTransGainLongTerm_HwNmpTransNm_f32;
} TSMit_Gain_Type;
...
# define Rte_TypeDef_CurrTempOffset3PhsType
typedef struct
{
  CurrTempOffsetTblType CurrTempOffsetX_DegC_s10p5;
  CurrTempOffsetTblType CurrOffsetA_Volt_s4p11;
  CurrTempOffsetTblType CurrOffsetB_Volt_s4p11;
  CurrTempOffsetTblType CurrOffsetC_Volt_s4p11;
} CurrTempOffset3PhsType;

# define Rte_TypeDef_DT_Array3x3_f32
typedef DT_Array3_f32 DT_Array3x3_f32[3];

# define Rte_TypeDef_SnsrLrndOffs_Str
typedef struct
{
  Float HwAgLrndTi;
  Float YawRateElpdTi;
  DT_Array3x3_f32 HwTqLrngCovariMtrx;
  DT_Array3_f32 HwTqLrngEstimnVect;
  SInt16 YawRateOffs;
  SInt16 HwAgOffs;
  SInt16 HwTqOffs;
  SInt16 HwAgLrngYawOffsRef;
  SInt16 HwAgLrngHwAgFilSt;
  SInt16 HwAgLrngSysTqFilSt;
  SInt16 HwTqLrngHwAgRef;
...
#  define Rte_TypeDef_HarCompTblSegment_DataType
typedef UInt16 HarCompTblSegment_DataType[257];
...
#  define Rte_TypeDef_HarCompTblData_DataType
typedef struct
{
  HarCompTbl MotMeclPosnHarCompTbl_Rev_s2p13;
  UInt16 StatusByte_Cnt_u16;
} HarCompTblData_DataType;
...
extern VAR(DT_MotMeclPosnCoeffTbl_f32, RTE_VAR_DEFAULT_RTE_Ap_10_PIM_GROUP) Rte_Sa_MotMeclPosn2_MotMeclPosn2CoeffTblData;
...
extern VAR(Float, RTE_VAR_DEFAULT_RTE_Ap_9_PIM_GROUP) Rte_Ap_ActivePull_PullCmpLTComp_HwNm_f32;
...
extern VAR(ThrmlDutyCycle_FltStVal_Datatype, RTE_VAR_DEFAULT_RTE_Ap_9_PIM_GROUP) Rte_Ap_ThrmlDutyCycle_ThrmlDutyCycle_FltStVal;
...
typedef struct
{
  Rte_DE_Boolean Rte_GetNVMSensorData_Cnt_lgc;
  Rte_DE_UInt8 Rte_NVMMotorVariant_Cnt_u08;
} Rte_tsRB_Ap_GmPwrpkSrvDataRcvry_GmPwrpkSrvDataRcvry_Per1;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_MtrCurrATempOffset_Volt_f32;
  Rte_DE_Float Rte_MtrCurrBTempOffset_Volt_f32;
  Rte_DE_Float Rte_MtrCurrCTempOffset_Volt_f32;
} Rte_tsRB_Sa_CmMtrCurr3Phs_CmMtrCurr3Phs_Per1;
...
typedef union
{
  Rte_tsRB_Ap_GmPwrpkSrvDataRcvry_GmPwrpkSrvDataRcvry_Per1 Rte_Ap_GmPwrpkSrvDataRcvry_GmPwrpkSrvDataRcvry_Per1;
  Rte_tsRB_Ap_CurrParamComp_CurrParamComp_Per2 Rte_Ap_CurrParamComp_CurrParamComp_Per2;
  Rte_tsRB_Sa_CmMtrCurr3Phs_CmMtrCurr3Phs_Per1 Rte_Sa_CmMtrCurr3Phs_CmMtrCurr3Phs_Per1;
...
} Rte_tsTB_Task_100ms_10;

typedef struct
{
  Rte_tsTB_Task_100ms_10 Rte_TB;
...
typedef struct
{
  Rte_DE_Float Rte_I_SrlComInput_SrlComAmbTemp_DegC_f32;
...
typedef struct
{
  ...
  Rte_DE_Boolean Rte_FeatureControl_Cnt_lgc;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_HwTorque_HwNm_f32;
  Rte_DE_Float Rte_PreLimitMtrTrqCmd_MtrNm_f32;
  Rte_DE_Boolean Rte_SrlComABSActive_Cnt_lgc;
  Rte_DE_Boolean Rte_SrlComESCActive_Cnt_lgc;
  Rte_DE_Boolean Rte_SrlComTCSActive_Cnt_lgc;
  Rte_DE_Float Rte_SrlComTransmissionTrq_TransNm_f32;
  Rte_DE_Float Rte_SrlComYawRate_DegpS_f32;
  Rte_DE_Boolean Rte_TSMitDefeat_Cnt_lgc;
  Rte_DE_Float Rte_VehicleSpeed_Kph_f32;
  Rte_DE_Float Rte_TSMitCommand_MtrNm_f32;
  Rte_DE_Boolean Rte_TSMitLearningEnabled_Cnt_lgc;
} Rte_tsRB_Ap_TSMit_TSMit_Per1;
...
typedef struct
{
  Rte_DE_Boolean Rte_OverVltgMonStart_Cnt_lgc;
...
typedef union
{
  ...
  Rte_tsRB_Ap_TSMit_TSMit_Per1 Rte_Ap_TSMit_TSMit_Per1;
...
} Rte_tsRB_Ap_SnsrOffsLrng_SnsrOffsLrng_Per2;
...
typedef union
{
  ...
  Rte_tsRB_Ap_SnsrOffsLrng_SnsrOffsLrng_Per2 Rte_Ap_SnsrOffsLrng_SnsrOffsLrng_Per2;
...
typedef struct
{
  Rte_DE_Float Rte_ADCMtrCurrA_Volt_f32;
  Rte_DE_Float Rte_ADCMtrCurrB_Volt_f32;
  Rte_DE_Float Rte_ADCMtrCurrC_Volt_f32;
  Rte_DE_Float Rte_CorrMtrCurrA_Amp_f32;
  Rte_DE_Float Rte_CorrMtrCurrB_Amp_f32;
  Rte_DE_Float Rte_CorrMtrCurrC_Amp_f32;
  Rte_DE_Float Rte_CorrMtrCurrPosition_Rev_f32;
  Rte_DE_Float Rte_CorrectedElecMtrPosFloat_Rev_f32;
  Rte_DE_Float Rte_DigMSBArbnMtrPosMecl_Rev_f32;
  ...
  Rte_DE_UInt32 Rte_MotMeclPosn1MeasdTi_USec_u32;
  Rte_DE_UInt16 Rte_MotMeclPosn1ParityFaultAccum_Cnt_u16;
  Rte_DE_UInt16 Rte_MotMeclPosn1RawErrReg_Cnt_u16;
  Rte_DE_UInt16 Rte_MotMeclPosn1RevM_Rev_u0p16;
  Rte_DE_UInt8 Rte_MotMeclPosn1RollgCntr_Cnt_u08;
  Rte_DE_UInt16 Rte_MotMeclPosn1UnderVltgFaultAccum_Cnt_u16;
  Rte_DE_UInt16 Rte_MotMeclPosn2ParityFaultAccum_Cnt_u16;
  Rte_DE_UInt16 Rte_MotMeclPosn2RawErrReg_Cnt_u16;
  Rte_DE_UInt8 Rte_MotMeclPosn2RollgCntr_Cnt_u08;
  Rte_DE_UInt16 Rte_MotMeclPosn2UnderVltgFaultAccum_Cnt_u16;
  Rte_DE_Float Rte_MotPosnCmpMotPosnCumvAlgnd_Rev_f32;
  Rte_DE_UInt16 Rte_MotPosnCmpMotPosnElec_Rev_u0p16;
  Rte_DE_Float Rte_MtrCtrlMtrDaxVoltage_Volt_f32;
  Rte_DE_Float Rte_MtrCtrlMtrQaxVoltage_Volt_f32;
  Rte_DE_Float Rte_MtrCurrDax_Amp_f32;
  Rte_DE_Float Rte_MtrCurrQax_Amp_f32;
  Rte_DE_Float Rte_MtrCurrQaxFinalRef_Amp_f32;
  Rte_DE_UInt16 Rte_SysCBattSwitched1_Cnt_u16;
  Rte_DE_UInt16 Rte_SysCBattSwitched2_Cnt_u16;
  Rte_DE_UInt16 Rte_SysCT1ADC_Cnt_u16;
  Rte_DE_UInt16 Rte_SysCT2ADC_Cnt_u16;
...
typedef struct
{
  Rte_DE_UInt16 Rte_SysCBattSwitched1ADC_Cnt_u16;
  Rte_DE_UInt16 Rte_SysCBattSwitched2ADC_Cnt_u16;
  Rte_DE_UInt16 Rte_SysCT1ADC_Cnt_u16;
  Rte_DE_UInt16 Rte_SysCT2ADC_Cnt_u16;
  Rte_DE_Float Rte_Batt_Volt_f32;
  Rte_DE_Float Rte_BattSwitched1_Volt_f32;
  Rte_DE_Float Rte_BattSwitched2_Volt_f32;
  Rte_DE_UInt16 Rte_MtrPos3Con_Volt_u3p13;
  Rte_DE_UInt16 Rte_MtrPos3Sin_Volt_u3p13;
  Rte_DE_Float Rte_SysCBattSwitched1_Volt_f32;
  Rte_DE_Float Rte_SysCBattSwitched2_Volt_f32;
  Rte_DE_Float Rte_SysCT1_Volt_f32;
  Rte_DE_Float Rte_SysCT2_Volt_f32;
  Rte_DE_Float Rte_TemperatureADC_Volt_f32;
  Rte_DE_Float Rte_Vref3p3_Volt_f32;
  Rte_DE_Float Rte_Vref5vp1_Volt_f32;
  Rte_DE_Float Rte_Vref5vp2_Volt_f32;
...
} Rte_tsRB_Sa_AnaHwTrq_AnaHwTrq_Per1;

typedef struct
{
  Rte_DE_SInt8 Rte_HwTq2Polarity_Cnt_s08;
  Rte_DE_Float Rte_T2ADC_Volt_f32;
} Rte_tsRB_Sa_AnaHwTrq_AnaHwTrq_Per2;

typedef struct
{
  Rte_DE_SInt8 Rte_HwTq3Polarity_Cnt_s08;
  Rte_DE_SInt8 Rte_HwTq4Polarity_Cnt_s08;
...
typedef struct
{
  ...
  Rte_DE_SigQlfr_State_enum Rte_HwTq3Qlfr_State_enum;
  Rte_DE_UInt8 Rte_HwTq3RollgCntr_Cnt_u08;
  Rte_DE_Float Rte_HwTq3Val_HwNm_f32;
  Rte_DE_SigQlfr_State_enum Rte_HwTq4Qlfr_State_enum;
  Rte_DE_UInt8 Rte_HwTq4RollgCntr_Cnt_u08;
  Rte_DE_Float Rte_HwTq4Val_HwNm_f32;
  Rte_DE_UInt16 Rte_HwTqCorrlnSts_Cnt_u16;
  Rte_DE_Float Rte_ArbnAbsHwTqErr_HwNm_f32;
} Rte_tsRB_Sa_HwTrqArbn_HwTrqArbn_Per1;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_VdAuthority_Uls_f32;
  Rte_DE_Float Rte_VdHwPos_HwDeg_f32;
  Rte_DE_Float Rte_HandwheelAuthority_Uls_f32;
...
typedef struct
{
  Rte_DE_Float Rte_HwAgOffs_HwDeg_f32;
  Rte_DE_Float Rte_HwPosn_HwDeg_f32;
  Rte_DE_Float Rte_HwTq_HwNm_f32;
  Rte_DE_Float Rte_HwTqOffs_HwNm_f32;
  Rte_DE_Float Rte_YawRate_DegpS_f32;
  Rte_DE_Float Rte_YawRateOffs_DegpS_f32;
  Rte_DE_Float Rte_HwAgCorrd_HwDeg_f32;
  Rte_DE_Float Rte_YawRateCorrd_DegpS_f32;
} Rte_tsRB_Ap_SnsrOffsCorrn_SnsrOffsCorrn_Per1;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_FricOffset_HwNm_f32;
  Rte_DE_Float Rte_HwTorque_HwNm_f32;
  Rte_DE_Float Rte_InpTqOvrl_HwNm_f32;
  Rte_DE_Float Rte_VehicleSpeed_Kph_f32;
  Rte_DE_Float Rte_WIRCmdAmpBlnd_MtrNm_f32;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_VehicleSpeed_Kph_f32;
} Rte_tsRB_CtrldVelRtn_CtrldVelRtn_Per1;
...
{
  Rte_DE_Float Rte_BaseAssistCmd_MtrNm_f32;
  Rte_DE_Boolean Rte_BrakePulsationEna_Cnt_lgc;
...
typedef struct
{
  Rte_DE_APA_State_enum Rte_APAState_State_enum;
  Rte_DE_Float Rte_EngSpd_Rpm_f32;
  Rte_DE_Float Rte_HandwheelVelocity_HwRadpS_f32;
  Rte_DE_Float Rte_HwTorque_HwNm_f32;
  Rte_DE_Boolean Rte_SS12VFault_Cnt_lgc;
  Rte_DE_Float Rte_VehicleSpeed_Kph_f32;
  Rte_DE_Float Rte_SSScale_Uls_f32;
  Rte_DE_Float Rte_SSSlew_UlspS_f32;
  Rte_DE_SS_State_enum Rte_SSState_State_enum;
} Rte_tsRB_Ap_GMStrtStop_StrtStop_Per1;
...
typedef struct
{
  ...
  Rte_DE_Boolean Rte_SysStReqDi_Cnt_lgc;
...
typedef struct
{
  ...
  Rte_DE_Boolean Rte_CntrlDampComp_Cnt_lgc;
...
typedef struct
{
  Rte_DE_UInt8 Rte_BattSwdVltgCorrlnSts_Cnt_u08;
  Rte_DE_Float Rte_BattVltg_Volt_f32;
  Rte_DE_Float Rte_BattVltgSwd1_Volt_f32;
  Rte_DE_Float Rte_BattVltgSwd2_Volt_f32;
  Rte_DE_Float Rte_BrdgVltg_Volt_f32;
} Rte_tsRB_Ap_BattVltg_BattVltg_Per1;
...
} Rte_tsRB_Sa_CmMtrCurr3Phs_CmMtrCurr3Phs_Per2;
...
} Rte_tsRB_Sa_CmMtrCurr3Phs_CmMtrCurr3Phs_Per3;

typedef struct
{
  Rte_DE_SInt8 Rte_AssiMechPolarity_Cnt_s08;
  Rte_DE_Float Rte_MotPosnCumvAlgnd_Rev_f32;
  Rte_DE_Float Rte_MotPosnCumvAlgndCrf_Deg_f32;
} Rte_tsRB_Ap_MotPosnCmp_MotPosnCmp_Per2;
...
typedef struct
{
  ...
  Rte_DE_UInt16 Rte_MotAgCorrlnMtrPosCorrlnSts_Cnt_u16;
  Rte_DE_Boolean Rte_MotCurrLoaMtgtnEn_Cnt_lgc;
  Rte_DE_SigQlfr_State_enum Rte_MotMeclPosn1MotPosnQlfr_State_enum;
  Rte_DE_SInt8 Rte_MotMeclPosn1Polarity_Cnt_s08;
  Rte_DE_SigQlfr_State_enum Rte_MotMeclPosn2MotPosnQlfr_State_enum;
  Rte_DE_SInt8 Rte_MotMeclPosn2Polarity_Cnt_s08;
  Rte_DE_Float Rte_MtrCurrATempOffset_Volt_f32;
  Rte_DE_Float Rte_MtrCurrBTempOffset_Volt_f32;
  Rte_DE_Float Rte_MtrCurrCTempOffset_Volt_f32;
...
} Rte_tsRB_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per2;

typedef struct
{
  Rte_DE_UInt16 Rte_MotMeclPosn1RawErrReg_Cnt_u16;
  Rte_DE_UInt16 Rte_ParityFaultAccum_Cnt_u16;
  Rte_DE_UInt16 Rte_UnderVltgFaultAccum_Cnt_u16;
} Rte_tsRB_Sa_MotMeclPosn1_MotMeclPosn1_Per2;
...
typedef struct
{
  ...
  Rte_DE_UInt16 Rte_ParityFaultAccum_Cnt_u16;
  Rte_DE_UInt16 Rte_UnderVltgFaultAccum_Cnt_u16;
} Rte_tsRB_Sa_MotMeclPosn2_MotMeclPosn2_Per2;

typedef struct
{
  Rte_DE_SInt8 Rte_MtrMechPos3Polarity_Cnt_s08;
  Rte_DE_UInt16 Rte_MtrPos3Cos_Volt_u3p13;
  Rte_DE_UInt16 Rte_MtrPos3Sin_Volt_u3p13;
} Rte_tsRB_Sa_MtrPos3SinCos_MtrPos3SinCos_Per1;

typedef struct
{
  Rte_DE_UInt16 Rte_MotMeclPosn1_Rev_u0p16;
  Rte_DE_SigQlfr_State_enum Rte_MotMeclPosn1Qlfr_State_enum;
  Rte_DE_UInt8 Rte_MotMeclPosn1RollgCntr_Cnt_u08;
  Rte_DE_UInt16 Rte_MotMeclPosn2_Rev_u0p16;
  Rte_DE_SigQlfr_State_enum Rte_MotMeclPosn2Qlfr_State_enum;
  Rte_DE_UInt8 Rte_MotMeclPosn2RollgCntr_Cnt_u08;
  Rte_DE_UInt16 Rte_MotMeclPosn3_Rev_u0p16;
  Rte_DE_SigQlfr_State_enum Rte_MotMeclPosn3Qlfr_State_enum;
  Rte_DE_UInt8 Rte_MotMeclPosn3RollgCntr_Cnt_u08;
  Rte_DE_UInt16 Rte_MtrPosCorrlnSts_Cnt_u16;
  Rte_DE_UInt8 Rte_MtrPosIdptSig_Cnt_u08;
} Rte_tsRB_Ap_MotAgCorrln_MotAgCorrln_Per1;

typedef struct
{
  Rte_DE_Boolean Rte_MtrDrvr0InitComplete_Cnt_lgc;
  Rte_DE_Boolean Rte_MtrDrvr1InitComplete_Cnt_lgc;
  Rte_DE_Boolean Rte_PwrDiscATestComplete_Cnt_lgc;
  Rte_DE_Boolean Rte_PwrDiscBTestComplete_Cnt_lgc;
  Rte_DE_Boolean Rte_TMFTestComplete_Cnt_lgc;
  Rte_DE_Boolean Rte_MtrDrvr0InitStart_Cnt_lgc;
  Rte_DE_Boolean Rte_MtrDrvr1InitStart_Cnt_lgc;
  Rte_DE_Boolean Rte_OverVltgMonStart_Cnt_lgc;
  Rte_DE_Boolean Rte_PwrDiscATestStart_Cnt_lgc;
  Rte_DE_Boolean Rte_PwrDiscBTestStart_Cnt_lgc;
  Rte_DE_Boolean Rte_TMFTestStart_Cnt_lgc;
} Rte_tsRB_Ap_HwPwrUpSeq_HwPwrUpSeq_Per1;

typedef struct
{
  Rte_DE_Boolean Rte_Inverter1Inactive_Cnt_lgc;
  Rte_DE_Boolean Rte_Inverter2Inactive_Cnt_lgc;
  Rte_DE_Boolean Rte_MtrDrvr1InitStart_Cnt_lgc;
  Rte_DE_Boolean Rte_MtrDrvr2InitStart_Cnt_lgc;
  Rte_DE_Boolean Rte_GateDrive1ResetActive_Cnt_lgc;
  Rte_DE_Boolean Rte_GateDrive2ResetActive_Cnt_lgc;
  Rte_DE_Boolean Rte_MtrDrvr1InitComplete_Cnt_lgc;
  Rte_DE_Boolean Rte_MtrDrvr2InitComplete_Cnt_lgc;
...
typedef struct
{
  Rte_DE_Boolean Rte_Inverter1Inactive_Cnt_lgc;
  Rte_DE_Boolean Rte_Inverter2Inactive_Cnt_lgc;
} Rte_tsRB_Sa_MtrDrvDiag_MtrDrvDiag_Per2;

typedef struct
{
  Rte_DE_Boolean Rte_DualEcuFltMtgtnEna_Cnt_lgc;
  Rte_DE_Boolean Rte_IvtrLoaMtgtnEn_Cnt_lgc;
  Rte_DE_Float Rte_MtrCurrDaxRef_Amp_f32;
  Rte_DE_Float Rte_MtrCurrQaxRef_Amp_f32;
  Rte_DE_Float Rte_EstKe_VpRadpS_f32;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_MtrCurrDaxRef_Amp_f32;
  Rte_DE_Float Rte_MtrCurrQaxRef_Amp_f32;
  Rte_DE_Float Rte_MtrTrqCmdMRFScl_MtrNm_f32;
} Rte_tsRB_Ap_TrqCanc_TrqCanc_Per1;

typedef struct
{
  Rte_DE_Boolean Rte_APANonRecoverableFaults_Cnt_lgc;
  Rte_DE_Boolean Rte_APARecoverableFaults_Cnt_lgc;
  Rte_DE_Boolean Rte_APARequest_Cnt_lgc;
  Rte_DE_Float Rte_CCWPosition_HwDeg_f32;
  Rte_DE_Float Rte_CWPosition_HwDeg_f32;
  Rte_DE_Boolean Rte_ESCFault_Cnt_lgc;
  Rte_DE_Boolean Rte_ESCIsLimited_Cnt_lgc;
  Rte_DE_Boolean Rte_ESCRequest_Cnt_lgc;
  Rte_DE_Boolean Rte_GMOSH_APAMfgEnable_Cnt_lgc;
  Rte_DE_Boolean Rte_GMOSH_ESCMfgEnable_Cnt_lgc;
  Rte_DE_Boolean Rte_GMOSH_LKAMfgEnable_Cnt_lgc;
  Rte_DE_Boolean Rte_HapticRequest_Cnt_lgc;
  Rte_DE_Float Rte_HwTorque_HwNm_f32;
  Rte_DE_Boolean Rte_LKAFault_Cnt_lgc;
  Rte_DE_Boolean Rte_LKAInhibit_Cnt_lgc;
  Rte_DE_Boolean Rte_LKARequest_Cnt_lgc;
  Rte_DE_LOA_State_enum Rte_LOASt_State_enum;
  Rte_DE_Float Rte_MaxSecureVehicleSpeed_Kph_f32;
  Rte_DE_Float Rte_MinSecureVehicleSpeed_Kph_f32;
  Rte_DE_Boolean Rte_PosTrajEnable_Cnt_lgc;
  Rte_DE_Float Rte_PosTrajHwAngle_HwDeg_f32;
  Rte_DE_Float Rte_SWARTrgtAngRequest_HwDeg_f32;
  Rte_DE_Boolean Rte_ShiftLeverIsInReverse_Cnt_lgc;
  Rte_DE_Float Rte_VehSpd_Kph_f32;
  Rte_DE_Boolean Rte_APADrvrInterventionDetected_Cnt_lgc;
  Rte_DE_APA_State_enum Rte_APAState_State_enum;
  Rte_DE_ESC_State_enum Rte_ESCState_State_enum;
  Rte_DE_Haptic_State_enum Rte_GMOSHOscillateState_State_enum;
  Rte_DE_LKA_State_enum Rte_LKAState_State_enum;
  Rte_DE_Boolean Rte_LkaDrvrIntvDetd_Cnt_lgc;
  Rte_DE_Boolean Rte_PosServEnable_Cnt_lgc;
...
} Rte_tsRB_Ap_TrqOvlSta_TrqOvlSta_Per1;
...
typedef struct
{
  Rte_DE_Float Rte_ESCCmd_HwNm_f32;
  Rte_DE_ESC_State_enum Rte_ESCState_State_enum;
  Rte_DE_Float Rte_HwTorque_HwNm_f32;
  Rte_DE_Float Rte_LKACmd_HwNm_f32;
  Rte_DE_LKA_State_enum Rte_LKAState_State_enum;
  Rte_DE_Float Rte_MaxSecureVehicleSpeed_Kph_f32;
  Rte_DE_Boolean Rte_PosServEnable_Cnt_lgc;
  Rte_DE_Float Rte_PosSrvoCmd_MtrNm_f32;
  ...
  Rte_DE_Float Rte_DampingDDFactor_Uls_f32;
  Rte_DE_Boolean Rte_ESCIsLimited_Cnt_lgc;
  Rte_DE_Float Rte_ESCTorqueDelivered_HwNm_f32;
  Rte_DE_Float Rte_IqTrqOv_HwNm_f32;
  Rte_DE_Float Rte_LKATorqueDelivered_HwNm_f32;
  Rte_DE_Float Rte_OpTrqOv_MtrNm_f32;
  Rte_DE_Boolean Rte_PullCmpCustLrngDi_Cnt_lgc;
  Rte_DE_Float Rte_ReturnDDFactor_Uls_f32;
} Rte_tsRB_Ap_TrqArblim_TrqArblim_Per1;

typedef struct
{
  Rte_DE_Float Rte_VBattADC_Volt_f32;
  Rte_DE_Float Rte_VSwitch1ADC_Volt_f32;
  Rte_DE_Float Rte_VSwitch2ADC_Volt_f32;
  Rte_DE_Boolean Rte_PwrDiscATestComplete_Cnt_lgc;
  Rte_DE_Boolean Rte_PwrDiscBTestComplete_Cnt_lgc;
} Rte_tsRB_Ap_PwrDscntDuInv_PwrDscntDuInv_Per1;
...
typedef struct
{
  ...
  Rte_DE_UInt32 Rte_MeasuredOnTimeD_Cnt_u32;
  Rte_DE_UInt32 Rte_MeasuredOnTimeE_Cnt_u32;
  Rte_DE_UInt32 Rte_MeasuredOnTimeF_Cnt_u32;
} Rte_tsRB_Cd_PhaseFdbkMeas_Cd_PhaseFdbkMeas_Per1;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_VdAuthority_Uls_f32;
  Rte_DE_Float Rte_VdHwPos_HwDeg_f32;
} Rte_tsRB_Ap_SASPlausDiag_SASPlausDiag_Per1;
...
typedef struct
{
  Rte_DE_Boolean Rte_Ivtr1Inactv_Cnt_lgc;
  Rte_DE_Boolean Rte_Ivtr2Inactv_Cnt_lgc;
} Rte_tsRB_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per4;
...
typedef union
{
  ...
  Rte_tsRB_Sa_AnaHwTrq_AnaHwTrq_Per1 Rte_Sa_AnaHwTrq_AnaHwTrq_Per1;
  Rte_tsRB_Sa_AnaHwTrq_AnaHwTrq_Per2 Rte_Sa_AnaHwTrq_AnaHwTrq_Per2;
  Rte_tsRB_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2 Rte_Cd_Nhet1CfgAndUse_Nhet1CfgAndUse_Per2;
  Rte_tsRB_Sa_HwTrqArbn_HwTrqArbn_Per1 Rte_Sa_HwTrqArbn_HwTrqArbn_Per1;
  ...
  Rte_tsRB_Ap_SnsrOffsCorrn_SnsrOffsCorrn_Per1 Rte_Ap_SnsrOffsCorrn_SnsrOffsCorrn_Per1;
  ...
  Rte_tsRB_CtrldVelRtn_CtrldVelRtn_Per1 Rte_CtrldVelRtn_CtrldVelRtn_Per1;
  ...
  Rte_tsRB_Ap_GMStrtStop_StrtStop_Per1 Rte_Ap_GMStrtStop_StrtStop_Per1;
  ...
  Rte_tsRB_Ap_BattVltg_BattVltg_Per1 Rte_Ap_BattVltg_BattVltg_Per1;
  ...
  Rte_tsRB_Sa_CmMtrCurr3Phs_CmMtrCurr3Phs_Per2 Rte_Sa_CmMtrCurr3Phs_CmMtrCurr3Phs_Per2;
  Rte_tsRB_Sa_CmMtrCurr3Phs_CmMtrCurr3Phs_Per3 Rte_Sa_CmMtrCurr3Phs_CmMtrCurr3Phs_Per3;
  Rte_tsRB_Ap_MotPosnCmp_MotPosnCmp_Per2 Rte_Ap_MotPosnCmp_MotPosnCmp_Per2;
  ...
  Rte_tsRB_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per2 Rte_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per2;
  Rte_tsRB_Sa_MotMeclPosn1_MotMeclPosn1_Per2 Rte_Sa_MotMeclPosn1_MotMeclPosn1_Per2;
  Rte_tsRB_Sa_MotMeclPosn2_MotMeclPosn2_Per2 Rte_Sa_MotMeclPosn2_MotMeclPosn2_Per2;
  Rte_tsRB_Sa_MtrPos3SinCos_MtrPos3SinCos_Per1 Rte_Sa_MtrPos3SinCos_MtrPos3SinCos_Per1;
  Rte_tsRB_Ap_MotAgCorrln_MotAgCorrln_Per1 Rte_Ap_MotAgCorrln_MotAgCorrln_Per1;
  Rte_tsRB_Ap_HwPwrUpSeq_HwPwrUpSeq_Per1 Rte_Ap_HwPwrUpSeq_HwPwrUpSeq_Per1;
  Rte_tsRB_Sa_MtrDrvDiag_MtrDrvDiag_Per1 Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per1;
  Rte_tsRB_Sa_MtrDrvDiag_MtrDrvDiag_Per2 Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per2;
  ...
  Rte_tsRB_Ap_TrqOvlSta_TrqOvlSta_Per1 Rte_Ap_TrqOvlSta_TrqOvlSta_Per1;
  Rte_tsRB_Ap_TrqOsc_TrqOsc_Per1 Rte_Ap_TrqOsc_TrqOsc_Per1;
  Rte_tsRB_Ap_PosServo_PosServo_Per1 Rte_Ap_PosServo_PosServo_Per1;
  Rte_tsRB_Ap_TrqArblim_TrqArblim_Per1 Rte_Ap_TrqArblim_TrqArblim_Per1;
  Rte_tsRB_Ap_PwrDscntDuInv_PwrDscntDuInv_Per1 Rte_Ap_PwrDscntDuInv_PwrDscntDuInv_Per1;
  Rte_tsRB_Ap_HOWDetect_HOWDetect_Per1 Rte_Ap_HOWDetect_HOWDetect_Per1;
  Rte_tsRB_Cd_PhaseFdbkMeas_Cd_PhaseFdbkMeas_Per1 Rte_Cd_PhaseFdbkMeas_Cd_PhaseFdbkMeas_Per1;
  ...
  Rte_tsRB_Ap_SASPlausDiag_SASPlausDiag_Per1 Rte_Ap_SASPlausDiag_SASPlausDiag_Per1;
  Rte_tsRB_Ap_GenPosTraj_GenPosTraj_Per1 Rte_Ap_GenPosTraj_GenPosTraj_Per1;
  Rte_tsRB_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per4 Rte_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per4;
  Rte_tsRB_Ap_StaMd_StaMd_Per1 Rte_Ap_StaMd_StaMd_Per1;
} Rte_tuRB_Task_2ms_10;

typedef struct
{
  Rte_DE_UInt32 Rte_I_CDDInterface_MotMeclPosn2MeasdTi_USec_u32;
  Rte_DE_UInt16 Rte_I_CDDInterface_MotMeclPosn2RevM_Rev_u0p16;
  Rte_DE_Float Rte_I_Ap_SignlCondn_VehicleSpeed_Kph_f32;
  Rte_DE_Boolean Rte_I_Ap_SignlCondn_VehicleSpeedValid_Cnt_lgc;
  Rte_DE_Float Rte_I_Ap_SignlCondn_VehicleYawRate_DegpS_f32;
  Rte_DE_Float Rte_I_IoHwAbstractionUsr_T1ADC_Volt_f32;
  Rte_DE_Float Rte_I_IoHwAbstractionUsr_T2ADC_Volt_f32;
  Rte_DE_SigQlfr_State_enum Rte_I_Sa_AnaHwTrq_HwTq1Qlfr_State_enum;
  Rte_DE_UInt8 Rte_I_Sa_AnaHwTrq_HwTq1RollgCntr_Cnt_u08;
  Rte_DE_Float Rte_I_Sa_AnaHwTrq_HwTq1Val_HwNm_f32;
  Rte_DE_SigQlfr_State_enum Rte_I_Sa_AnaHwTrq_HwTq2Qlfr_State_enum;
  Rte_DE_UInt8 Rte_I_Sa_AnaHwTrq_HwTq2RollgCntr_Cnt_u08;
  Rte_DE_Float Rte_I_Sa_AnaHwTrq_HwTq2Val_HwNm_f32;
  Rte_DE_SigQlfr_State_enum Rte_I_Cd_Nhet1CfgAndUse_HwTq3Qlfr_State_enum;
  Rte_DE_UInt8 Rte_I_Cd_Nhet1CfgAndUse_HwTq3RollgCntr_Cnt_u08;
  Rte_DE_Float Rte_I_Cd_Nhet1CfgAndUse_HwTq3Val_HwNm_f32;
  Rte_DE_SigQlfr_State_enum Rte_I_Cd_Nhet1CfgAndUse_HwTq4Qlfr_State_enum;
  Rte_DE_UInt8 Rte_I_Cd_Nhet1CfgAndUse_HwTq4RollgCntr_Cnt_u08;
  Rte_DE_Float Rte_I_Cd_Nhet1CfgAndUse_HwTq4Val_HwNm_f32;
  Rte_DE_UInt16 Rte_I_Sa_HwTqCorrln_HwTqCorrlnSts_Cnt_u16;
  Rte_DE_Float Rte_I_Sa_HwTrqArbn_HwTqVal_HwNm_f32;
  Rte_DE_Float Rte_I_AbsHwPos_HandwheelPosition_HwDeg_f32;
  Rte_DE_Float Rte_I_Ap_SnsrOffsCorrn_HwTqCorrd_HwNm_f32;
  Rte_DE_Float Rte_I_Ap_Sweep_OutputHwTrq_HwNm_f32;
  Rte_DE_Float Rte_I_Ap_TrqArblim_IqTrqOv_HwNm_f32;
  ...
  Rte_DE_Float Rte_I_Ap_SnsrOffsCorrn_HwAgCorrd_HwDeg_f32;
  Rte_DE_Float Rte_I_CtrldVelRtn_ReturnCmd_MtrNm_f32;
  Rte_DE_Float Rte_I_StOpCtrl_OutputRampMult_Uls_f32;
  Rte_DE_Float Rte_I_Ap_LmtCod_EOTGainLtd_Uls_f32;
  Rte_DE_Float Rte_I_Ap_LmtCod_EOTLimitLtd_MtrNm_f32;
  Rte_DE_Float Rte_I_Ap_LmtCod_OutputRampMultLtd_Uls_f32;
  Rte_DE_Float Rte_I_Ap_LmtCod_StallLimitLtd_MtrNm_f32;
  Rte_DE_Float Rte_I_Ap_LmtCod_ThermalLimitLtd_MtrNm_f32;
  Rte_DE_Float Rte_I_Ap_LmtCod_VehSpdLimitLtd_MtrNm_f32;
  Rte_DE_Float Rte_I_AbsHwPos_HandwheelAuthority_Uls_f32;
  Rte_DE_Float Rte_I_Sa_MtrVel_MotorVelCRF_MtrRadpS_f32;
  Rte_DE_Float Rte_I_Ap_TrqLOA_TrqLOACmd_MtrNm_f32;
  ...
  Rte_DE_Float Rte_I_Ap_EtDmpFw_EOTDampingLtd_MtrNm_f32;
  Rte_DE_Float Rte_I_Ap_AstLmt_SumLimTrqCmd_MtrNm_f32;
  Rte_DE_Float Rte_I_Ap_Sweep2_OutputMtrTrq_MtrNm_f32;
  Rte_DE_Float Rte_I_Ap_MotPosnCmp_MotPosnCumvAlgndMrf_Deg_f32;
  Rte_DE_Float Rte_I_TrqCmdScl_MRFMtrTrqCmdScl_MtrNm_f32;
  Rte_DE_UInt8 Rte_I_QuadDet_MtrQuad_Cnt_u08;
  Rte_DE_Boolean Rte_I_Ap_LoaMgr_IvtrLoaMtgtnEn_Cnt_lgc;
  Rte_DE_Float Rte_I_Sa_MtrVel_MotorVelMRF_MtrRadpS_f32;
  Rte_DE_Boolean Rte_I_Ap_LoaMgr_MotCurrLoaMtgtnEn_Cnt_lgc;
  Rte_DE_Float Rte_I_Ap_BattVltg_BrdgVltg_Volt_f32;
  Rte_DE_SigQlfr_State_enum Rte_I_Sa_MotMeclPosn1_MotPosnQlfr_State_enum;
  Rte_DE_SigQlfr_State_enum Rte_I_Sa_MotMeclPosn2_MotPosnQlfr_State_enum;
  Rte_DE_UInt16 Rte_I_Sa_MtrPos3SinCos_MtrPos3Mech_Rev_u0p16;
  Rte_DE_SigQlfr_State_enum Rte_I_Sa_MtrPos3SinCos_MtrPos3Qlfr_State_enum;
  Rte_DE_UInt8 Rte_I_Sa_MtrPos3SinCos_MtrPos3RollgCntr_Cnt_u08;
  Rte_DE_Float Rte_I_Ap_TranlDampg_CRFMtrTrqCmd_MtrNm_f32;
...
typedef struct
{
  ...
  Rte_DE_UInt8 Rte_BattSwdVltgCorrlnSts_Cnt_u08;
  Rte_DE_UInt8 Rte_BattVltgCorrlnIdptSig_Cnt_u08;
  Rte_DE_Boolean Rte_DftBrdgVltgActv_Cnt_lgc;
  Rte_DE_Boolean Rte_SwdVltgLimd_Cnt_lgc;
} Rte_tsRB_Ap_BattVltgCorrln_BattVltgCorrln_Per1;
...
typedef struct
{
  ...
  Rte_DE_Boolean Rte_DftVehSpdEna_Cnt_lgc;
  Rte_DE_Float Rte_OperRampRate_XpmS_f32;
  Rte_DE_Float Rte_OperRampValue_Uls_f32;
  Rte_DE_Float Rte_SysOperMotTqCmdSca_Uls_f32;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_VehicleSpeed_Kph_f32;
  Rte_DE_Boolean Rte_VehicleSpeedValid_Cnt_lgc;
} Rte_tsRB_Ap_SnsrOffsLrng_SnsrOffsLrng_Per1;

typedef union
{
  Rte_tsRB_Ap_BattVltgCorrln_BattVltgCorrln_Per1 Rte_Ap_BattVltgCorrln_BattVltgCorrln_Per1;
  ...
  Rte_tsRB_Ap_SnsrOffsLrng_SnsrOffsLrng_Per1 Rte_Ap_SnsrOffsLrng_SnsrOffsLrng_Per1;
} Rte_tuRB_Task_2ms_9;
...
typedef struct
{
  Rte_DE_Float Rte_ArbnAbsTqErr_HwNm_f32;
  Rte_DE_Float Rte_HwTq1Val_HwNm_f32;
  Rte_DE_Float Rte_HwTq2Val_HwNm_f32;
  Rte_DE_Float Rte_HwTq3Val_HwNm_f32;
  Rte_DE_Float Rte_HwTq4Val_HwNm_f32;
  Rte_DE_UInt8 Rte_HwTqIdptSig_Cnt_u08;
  Rte_DE_UInt8 Rte_HwTqVldSrcSig_Cnt_u08;
...
typedef struct
{
  Rte_DE_Float Rte_I_DigColPs_I2CHwAbsPos_HwDeg_f32;
  Rte_DE_Boolean Rte_I_DigColPs_I2CHwAbsPosValid_Cnt_lgc;
...
typedef struct
{
  ...
  Rte_DE_SigQlfr_State_enum Rte_HwTq2Qlfr_State_enum;
  Rte_DE_UInt8 Rte_HwTq2RollgCntr_Cnt_u08;
} Rte_tsRB_Sa_AnaHwTrq_AnaHwTrq_Init;
...
typedef struct
{
  ...
  Rte_DE_SInt8 Rte_MtrPosPolarity_Cnt_s08;
  Rte_DE_ManufModeType Rte_MEC_Cnt_enum;
} Rte_tsRB_Sa_CDDInterface_CDDInterface_Init2;

typedef struct
{
  Rte_DE_Float Rte_BrdgVltg_Volt_f32;
} Rte_tsRB_Ap_BattVltg_BattVltg_Init1;
...
typedef union
{
  ...
  Rte_tsRB_Sa_AnaHwTrq_AnaHwTrq_Init Rte_Sa_AnaHwTrq_AnaHwTrq_Init;
  ...
  Rte_tsRB_Sa_CDDInterface_CDDInterface_Init2 Rte_Sa_CDDInterface_CDDInterface_Init2;
  Rte_tsRB_Ap_BattVltg_BattVltg_Init1 Rte_Ap_BattVltg_BattVltg_Init1;
...
typedef struct
{
  Rte_DE_Float Rte_HwAgOffs_HwDeg_f32;
  Rte_DE_Float Rte_HwTqOffs_HwNm_f32;
  Rte_DE_Float Rte_VehYawRateOffs_DegpS_f32;
} Rte_tsRB_Ap_SnsrOffsLrng_SnsrOffsLrng_Init1;
...
typedef union
{
  ...
  Rte_tsRB_Ap_SnsrOffsLrng_SnsrOffsLrng_Init1 Rte_Ap_SnsrOffsLrng_SnsrOffsLrng_Init1;
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
