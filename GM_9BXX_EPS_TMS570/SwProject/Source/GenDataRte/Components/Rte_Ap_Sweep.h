...
#  define Rte_IWrite_Sweep_Per1_OutputHwTrq_HwNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_Sweep_OutputHwTrq_HwNm_f32.value = (data) \
  )
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_Sweep.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
