...
#  define Rte_IRead_SignlCondn_Per1_SrlComVehLatAccelValid_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_SrlComVehLatAccelValid_Cnt_lgc.value)

#  define Rte_IRead_SignlCondn_Per1_SrlComVehLatAccel_MpSecSq_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_SrlComVehLatAccel_MpSecSq_f32.value)

#  define Rte_IRead_SignlCondn_Per1_SrlComVehLonAccelValid_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_SrlComVehLonAccelValid_Cnt_lgc.value)

#  define Rte_IRead_SignlCondn_Per1_SrlComVehLonAccel_MpSecSq_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_SrlComVehLonAccel_MpSecSq_f32.value)

#  define Rte_IRead_SignlCondn_Per1_SrlComVehSpeedValid_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_SrlComVehSpeedValid_Cnt_lgc.value)
...
#  define Rte_IRead_SignlCondn_Per1_SrlComVehYawRateValid_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_SrlComVehYawRateValid_Cnt_lgc.value)

#  define Rte_IRead_SignlCondn_Per1_SrlComVehYawRate_DegpS_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_SrlComVehYawRate_DegpS_f32.value)

#  define Rte_IWrite_SignlCondn_Per1_EstimdLatAcceValid_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_EstimdLatAcceValid_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_SignlCondn_Per1_EstimdLatAcceValid_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_EstimdLatAcceValid_Cnt_lgc.value)

#  define Rte_IWrite_SignlCondn_Per1_EstimdLatAcce_MpSecSq_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_EstimdLatAcce_MpSecSq_f32.value = (data) \
  )

#  define Rte_IWriteRef_SignlCondn_Per1_EstimdLatAcce_MpSecSq_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_EstimdLatAcce_MpSecSq_f32.value)

#  define Rte_IWrite_SignlCondn_Per1_VehicleLatAcceValid_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_VehicleLatAcceValid_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_SignlCondn_Per1_VehicleLatAcceValid_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_VehicleLatAcceValid_Cnt_lgc.value)

#  define Rte_IWrite_SignlCondn_Per1_VehicleLatAccel_MpSecSq_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_VehicleLatAccel_MpSecSq_f32.value = (data) \
  )

#  define Rte_IWriteRef_SignlCondn_Per1_VehicleLatAccel_MpSecSq_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_VehicleLatAccel_MpSecSq_f32.value)

#  define Rte_IWrite_SignlCondn_Per1_VehicleLonAccelValid_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_VehicleLonAccelValid_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_SignlCondn_Per1_VehicleLonAccelValid_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_VehicleLonAccelValid_Cnt_lgc.value)

#  define Rte_IWrite_SignlCondn_Per1_VehicleLonAccel_KphpS_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_VehicleLonAccel_KphpS_f32.value = (data) \
  )

#  define Rte_IWriteRef_SignlCondn_Per1_VehicleLonAccel_KphpS_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_VehicleLonAccel_KphpS_f32.value)

#  define Rte_IWrite_SignlCondn_Per1_VehicleSpeedValid_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_SignlCondn_VehicleSpeedValid_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_SignlCondn_Per1_VehicleSpeedValid_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_SignlCondn_VehicleSpeedValid_Cnt_lgc.value)

#  define Rte_IWrite_SignlCondn_Per1_VehicleSpeed_Kph_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_SignlCondn_VehicleSpeed_Kph_f32.value = (data) \
  )
...
#  define Rte_IWrite_SignlCondn_Per1_VehicleYawRateValid_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_VehicleYawRateValid_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_SignlCondn_Per1_VehicleYawRateValid_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_SignlCondn_SignlCondn_Per1.Rte_VehicleYawRateValid_Cnt_lgc.value)

#  define Rte_IWrite_SignlCondn_Per1_VehicleYawRate_DegpS_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_SignlCondn_VehicleYawRate_DegpS_f32.value = (data) \
  )
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_SignlCondn.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
