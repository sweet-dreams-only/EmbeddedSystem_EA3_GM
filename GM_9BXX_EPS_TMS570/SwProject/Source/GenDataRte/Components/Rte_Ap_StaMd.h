...
#  define Rte_Call_CloseCheckData_GetErrorStatus(arg1) (NvMProxy_GetErrorStatus((UInt8)2, arg1), ((Std_ReturnType)RTE_E_OK))
#  define RTE_START_SEC_NVMPROXY_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_CloseCheckData_WriteBlock(arg1) (NvMProxy_WriteBlock((UInt8)2, arg1))
...
#  define Rte_Call_TypeHData_WriteBlock(arg1) (NvMProxy_WriteBlock((UInt8)3, arg1))
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_StaMd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
