...
#  define Rte_IRead_LoaMgr_Per1_HwTqIdptSig_Cnt_u08() \
  (Rte_Task_4ms_10.Rte_RB.Rte_Ap_LoaMgr_LoaMgr_Per1.Rte_HwTqIdptSig_Cnt_u08.value)
...
#  define Rte_IWrite_LoaMgr_Per1_LoaRateLimit_UlspS_f32(data) \
  ( \
    Rte_Task_4ms_10.Rte_RB.Rte_Ap_LoaMgr_LoaMgr_Per1.Rte_LoaRateLimit_UlspS_f32.value = (data) \
  )

#  define Rte_IWriteRef_LoaMgr_Per1_LoaRateLimit_UlspS_f32() \
  (&Rte_Task_4ms_10.Rte_RB.Rte_Ap_LoaMgr_LoaMgr_Per1.Rte_LoaRateLimit_UlspS_f32.value)

#  define Rte_IWrite_LoaMgr_Per1_LoaScaleFctr_Uls_f32(data) \
  ( \
    Rte_Task_4ms_10.Rte_RB.Rte_Ap_LoaMgr_LoaMgr_Per1.Rte_LoaScaleFctr_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_LoaMgr_Per1_LoaScaleFctr_Uls_f32() \
  (&Rte_Task_4ms_10.Rte_RB.Rte_Ap_LoaMgr_LoaMgr_Per1.Rte_LoaScaleFctr_Uls_f32.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_LoaMgr.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
