...
/************************************************************************/
extern VAR(UInt8, RTE_VAR_INIT) Rte_DiagMgr_DiagNoofActiveInverter_Cnt_u08;
...
extern VAR(Boolean, RTE_VAR_INIT) Rte_DiagMgr_DiagStsInverter1Inactive_Cnt_lgc;
extern VAR(Boolean, RTE_VAR_INIT) Rte_DiagMgr_DiagStsInverter2Inactive_Cnt_lgc;
...
extern VAR(Float, RTE_VAR_INIT) Rte_Ap_Sweep_OutputHwTrq_HwNm_f32;
...
#  define Rte_Read_Ap_DiagMgr10_HwTrq_HwNm_f32(data) (*(data) = Rte_Ap_Sweep_OutputHwTrq_HwNm_f32, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Read_Ap_DiagMgr10_MtrTrq_MtrNm_f32(data) (*(data) = Rte_Ap_TranlDampg_MRFMtrTrqCmd_MtrNm_f32, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Write_Ap_DiagMgr10_DiagNoofActiveInverter_Cnt_u08(data) (Rte_DiagMgr_DiagNoofActiveInverter_Cnt_u08 = (data), ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Write_Ap_DiagMgr10_DiagStsInverter1Inactive_Cnt_lgc(data) (Rte_DiagMgr_DiagStsInverter1Inactive_Cnt_lgc = (data), ((Std_ReturnType)RTE_E_OK))
#  define Rte_Write_DiagStsInverter2Inactive_Cnt_lgc Rte_Write_Ap_DiagMgr10_DiagStsInverter2Inactive_Cnt_lgc
#  define Rte_Write_Ap_DiagMgr10_DiagStsInverter2Inactive_Cnt_lgc(data) (Rte_DiagMgr_DiagStsInverter2Inactive_Cnt_lgc = (data), ((Std_ReturnType)RTE_E_OK))
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_DiagMgr10.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
