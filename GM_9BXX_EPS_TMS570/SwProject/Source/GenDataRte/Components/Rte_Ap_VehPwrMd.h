...
#  define Rte_InitValue_DftVehSpdEna_Cnt_lgc (FALSE)
...
#  define Rte_InitValue_SysOperMotTqCmdSca_Uls_f32 (1.0F)
...
#  define Rte_IRead_VehPwrMd_Per1_HwTrq_HwNm_f32() \
  (Rte_Task_2ms_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_HwTrq_HwNm_f32.value)

#  define Rte_IRead_VehPwrMd_Per1_SrlComEngOn_Cnt_lgc() \
  (Rte_Task_2ms_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_SrlComEngOn_Cnt_lgc.value)

#  define Rte_IRead_VehPwrMd_Per1_SrlComSPMOn_Cnt_lgc() \
  (Rte_Task_2ms_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_SrlComSPMOn_Cnt_lgc.value)
...
#  define Rte_IWrite_VehPwrMd_Per1_DftVehSpdEna_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_DftVehSpdEna_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_VehPwrMd_Per1_DftVehSpdEna_Cnt_lgc() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_DftVehSpdEna_Cnt_lgc.value)
...
#  define Rte_IWrite_VehPwrMd_Per1_SysOperMotTqCmdSca_Uls_f32(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_SysOperMotTqCmdSca_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_VehPwrMd_Per1_SysOperMotTqCmdSca_Uls_f32() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Ap_VehPwrMd_VehPwrMd_Per1.Rte_SysOperMotTqCmdSca_Uls_f32.value)
...
#  define Rte_Call_SrlComInput_SCom_ResetBus1Timers() (SrlComInput_SCom_ResetBus1Timers(), ((Std_ReturnType)RTE_E_OK))
#  define RTE_START_SEC_AP_SRLCOMINPUT_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_SrlComInput_SCom_ResetBus2Timers() (SrlComInput_SCom_ResetBus2Timers(), ((Std_ReturnType)RTE_E_OK))
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_VehPwrMd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
