...
#  define Rte_IRead_Ap_TranlDampg_Per1_SumLimTrqCmd_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_Sweep2_OutputMtrTrq_MtrNm_f32.value)
...
#  define Rte_IWrite_Ap_TranlDampg_Per1_CntrlDampComp_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_TranlDampg_Ap_TranlDampg_Per1.Rte_CntrlDampComp_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_Ap_TranlDampg_Per1_CntrlDampComp_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_TranlDampg_Ap_TranlDampg_Per1.Rte_CntrlDampComp_Cnt_lgc.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_TranlDampg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
