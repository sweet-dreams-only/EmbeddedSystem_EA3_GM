...
#  define Rte_IRead_PosServo_Per1_HandwheelPosition_HwDeg_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_HandwheelPosition_HwDeg_f32.value)

#  define Rte_IRead_PosServo_Per1_HwTorque_HwNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_HwTorque_HwNm_f32.value)

#  define Rte_IRead_PosServo_Per1_MotorVelCRF_MtrRadpS_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_MotorVelCRF_MtrRadpS_f32.value)

#  define Rte_IRead_PosServo_Per1_PosSrvoEnable_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_PosSrvoEnable_Cnt_lgc.value)

#  define Rte_IRead_PosServo_Per1_PosSrvoHwAngle_HwDeg_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_PosSrvoHwAngle_HwDeg_f32.value)

#  define Rte_IRead_PosServo_Per1_VehicleSpeed_Kph_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_VehicleSpeed_Kph_f32.value)

#  define Rte_IWrite_PosServo_Per1_PosSrvoCmd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_PosSrvoCmd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_PosServo_Per1_PosSrvoCmd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_PosSrvoCmd_MtrNm_f32.value)

#  define Rte_IWrite_PosServo_Per1_PosSrvoReturnSclFct_Uls_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_PosSrvoReturnSclFct_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_PosServo_Per1_PosSrvoReturnSclFct_Uls_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_PosSrvoReturnSclFct_Uls_f32.value)

#  define Rte_IWrite_PosServo_Per1_PosSrvoSmoothEnable_Uls_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_PosSrvoSmoothEnable_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_PosServo_Per1_PosSrvoSmoothEnable_Uls_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_PosSrvoSmoothEnable_Uls_f32.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_PosServo.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
