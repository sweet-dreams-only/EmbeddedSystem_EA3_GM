...
#  define Rte_InitValue_DualEcuFltMtgtnEna_Cnt_lgc (FALSE)
...
#  define Rte_IRead_CurrParamComp_Per1_DualEcuFltMtgtnEna_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrParamComp_CurrParamComp_Per1.Rte_DualEcuFltMtgtnEna_Cnt_lgc.value)

#  define Rte_IRead_CurrParamComp_Per1_IvtrLoaMtgtnEn_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrParamComp_CurrParamComp_Per1.Rte_IvtrLoaMtgtnEn_Cnt_lgc.value)
...
#  define Rte_Call_EOLNomMtrParamBlk_WriteBlock(arg1) (NvMProxy_WriteBlock((UInt8)5, arg1))
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_CurrParamComp.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
