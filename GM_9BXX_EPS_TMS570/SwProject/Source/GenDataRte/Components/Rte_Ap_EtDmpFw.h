...
#  define Rte_IWrite_EtDmpFw_Per1_EOTDampingLtd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_EtDmpFw_EOTDampingLtd_MtrNm_f32.value = (data) \
  )
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_EtDmpFw.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
