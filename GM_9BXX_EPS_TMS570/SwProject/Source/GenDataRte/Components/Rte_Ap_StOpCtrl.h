...
#  define Rte_IWrite_StOpCtrl_Per1_SysStReqDi_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_StOpCtrl_StOpCtrl_Per1.Rte_SysStReqDi_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_StOpCtrl_Per1_SysStReqDi_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_StOpCtrl_StOpCtrl_Per1.Rte_SysStReqDi_Cnt_lgc.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_StOpCtrl.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
