...
#  define Rte_Read_Ap_DiagMgr8_HwTrq_HwNm_f32(data) (*(data) = Rte_Ap_Sweep_OutputHwTrq_HwNm_f32, ((Std_ReturnType)RTE_E_OK))
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_DiagMgr8.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
