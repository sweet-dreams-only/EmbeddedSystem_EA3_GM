...
#  define Rte_Call_ChkPtAp10_100msEnd_CP_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)1, (WdgM_CheckpointIdType)1))
#  define Rte_Call_ChkPtAp10_100msStart_CP_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)1, (WdgM_CheckpointIdType)0))
...
#  define Rte_Call_ChkPtAp10_2msEnd_CP_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)6, (WdgM_CheckpointIdType)1))
#  define Rte_Call_ChkPtAp10_2msStart_CP_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)6, (WdgM_CheckpointIdType)0))
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_ChkPtAp10.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
