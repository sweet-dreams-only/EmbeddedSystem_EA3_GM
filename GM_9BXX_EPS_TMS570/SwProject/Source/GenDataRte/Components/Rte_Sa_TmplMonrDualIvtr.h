 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Sa_TmplMonrDualIvtr.h
...
#ifndef _RTE_SA_TMPLMONRDUALIVTR_H
# define _RTE_SA_TMPLMONRDUALIVTR_H
...
#  define Rte_InitValue_Ivtr1Inactv_Cnt_lgc (FALSE)
#  define Rte_InitValue_Ivtr2Inactv_Cnt_lgc (FALSE)
...
#  define Rte_IRead_TmplMonrDualIvtr_Per2_TMFTestStart_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per2.Rte_TMFTestStart_Cnt_lgc.value)

#  define Rte_IWrite_TmplMonrDualIvtr_Per2_TMFTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per2.Rte_TMFTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_TmplMonrDualIvtr_Per2_TMFTestComplete_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per2.Rte_TMFTestComplete_Cnt_lgc.value)

#  define Rte_IRead_TmplMonrDualIvtr_Per4_Ivtr1Inactv_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per4.Rte_Ivtr1Inactv_Cnt_lgc.value)

#  define Rte_IRead_TmplMonrDualIvtr_Per4_Ivtr2Inactv_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_TmplMonrDualIvtr_TmplMonrDualIvtr_Per4.Rte_Ivtr2Inactv_Cnt_lgc.value)
...
#  define Rte_Call_SysFault2A_OP_SET IoHwAb_SetSysFault2A
#  define RTE_START_SEC_IOHWABSTRACTION_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_SysFault2B_OP_SET IoHwAb_SetSysFault2B
#  define RTE_START_SEC_IOHWABSTRACTION_APPL_CODE
#  include "MemMap.h"
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_TmplMonrDualIvtr.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_SA_TMPLMONRDUALIVTR_H */
