 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Sa_TmplMonrDualIvtr2.h
...
#ifndef _RTE_SA_TMPLMONRDUALIVTR2_H
# define _RTE_SA_TMPLMONRDUALIVTR2_H
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_TmplMonrDualIvtr2.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_SA_TMPLMONRDUALIVTR2_H */
