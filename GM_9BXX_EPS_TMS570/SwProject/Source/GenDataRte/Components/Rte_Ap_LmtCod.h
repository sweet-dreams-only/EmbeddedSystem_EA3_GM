...
#  define Rte_IWrite_LmtCod_Per1_EOTGainLtd_Uls_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_EOTGainLtd_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_EOTGainLtd_Uls_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_EOTGainLtd_Uls_f32.value)

#  define Rte_IWrite_LmtCod_Per1_EOTLimitLtd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_EOTLimitLtd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_EOTLimitLtd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_EOTLimitLtd_MtrNm_f32.value)

#  define Rte_IWrite_LmtCod_Per1_OutputRampMultLtd_Uls_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_OutputRampMultLtd_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_OutputRampMultLtd_Uls_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_OutputRampMultLtd_Uls_f32.value)

#  define Rte_IWrite_LmtCod_Per1_StallLimitLtd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_StallLimitLtd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_StallLimitLtd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_StallLimitLtd_MtrNm_f32.value)

#  define Rte_IWrite_LmtCod_Per1_ThermalLimitLtd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_ThermalLimitLtd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_ThermalLimitLtd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_ThermalLimitLtd_MtrNm_f32.value)

#  define Rte_IWrite_LmtCod_Per1_VehSpdLimitLtd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_VehSpdLimitLtd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_LmtCod_Per1_VehSpdLimitLtd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_LmtCod_VehSpdLimitLtd_MtrNm_f32.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_LmtCod.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
