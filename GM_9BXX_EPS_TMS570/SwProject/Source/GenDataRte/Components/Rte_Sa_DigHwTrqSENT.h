...
extern VAR(Float, RTE_VAR_INIT) Rte_Sa_DigHwTrqSENT_T1_HwNm_f32;
extern VAR(Float, RTE_VAR_INIT) Rte_Sa_DigHwTrqSENT_T2_HwNm_f32;
...
#  define Rte_IWrite_DigHwTrqSENT_Per1_HwTorque_HwNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Sa_DigHwTrqSENT_HwTorque_HwNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_DigHwTrqSENT_Per1_HwTorque_HwNm_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Sa_DigHwTrqSENT_HwTorque_HwNm_f32.value)
...
#  define Rte_Read_Sa_DigHwTrqSENT_T1_HwNm_f32(data) (*(data) = Rte_Sa_DigHwTrqSENT_T1_HwNm_f32, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_T2_HwNm_f32 Rte_Read_Sa_DigHwTrqSENT_T2_HwNm_f32
#  define Rte_Read_Sa_DigHwTrqSENT_T2_HwNm_f32(data) (*(data) = Rte_Sa_DigHwTrqSENT_T2_HwNm_f32, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Call_NvM_DigHwTrqSENTTrim_Srv_GetErrorStatus(arg1) (NvMProxy_GetErrorStatus((UInt8)6, arg1), ((Std_ReturnType)RTE_E_OK))
#  define RTE_START_SEC_NVMPROXY_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_NvM_DigHwTrqSENTTrim_Srv_WriteBlock(arg1) (NvMProxy_WriteBlock((UInt8)6, arg1))
...
extern VAR(DigHwTrqSENTTrim_DataType, RTE_VAR_DEFAULT_RTE_Ap_10_PIM_GROUP) Rte_Sa_DigHwTrqSENT_DigTrqTrim;
...
#  define Rte_Pim_DigTrqTrim() \
  (&Rte_Sa_DigHwTrqSENT_DigTrqTrim)
...
#    error "The magic number of the generated file <C:/_synergy/9BXX_CZ8L9T/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_DigHwTrqSENT.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
