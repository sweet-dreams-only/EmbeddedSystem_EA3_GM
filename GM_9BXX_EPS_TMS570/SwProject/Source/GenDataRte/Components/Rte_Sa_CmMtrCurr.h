 ...
 *   ECU-Project:  EPS
 *  Generated at:  Mon Aug 17 15:07:40 2015
 *
...
#  define Rte_Read_Sa_CmMtrCurr_MtrVel_MtrRadpS_f32(data) (*(data) = Rte_Sa_MtrVel_MotorVelMRF_MtrRadpS_f32, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Read_Sa_CmMtrCurr_VhSpdValid_Cnt_lgc(data) (*(data) = Rte_Ap_SignlCondn_VehicleSpeedValid_Cnt_lgc, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Call_EOLCurrTempOffset_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)5, arg1))
...
#   if RTE_MAGIC_NUMBER != 1439837089
#    error "The magic number of the generated file <C:/_synergy/9BXX_CZ8L9T/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_CmMtrCurr.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1439837089
