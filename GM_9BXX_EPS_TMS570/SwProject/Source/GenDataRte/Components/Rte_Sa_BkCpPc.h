 ...
 *   ECU-Project:  EPS
 *  Generated at:  Wed Aug 19 10:39:29 2015
 *
...
#  define Rte_IRead_BkCpPc_Per1_BattSwitched_Volt_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_BattSwitched_Volt_f32.value)

#  define Rte_IRead_BkCpPc_Per1_Batt_Volt_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_Batt_Volt_f32.value)

#  define Rte_IRead_BkCpPc_Per1_MotorVelocityMRFUnfiltered_MtrRadpS_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_MotorVelocityMRFUnfiltered_MtrRadpS_f32.value)

#  define Rte_IRead_BkCpPc_Per1_OVERRIDESIGDIAGADC_Volt_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_OVERRIDESIGDIAGADC_Volt_f32.value)

#  define Rte_IRead_BkCpPc_Per1_PMOSDIAGADC_Volt_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PMOSDIAGADC_Volt_f32.value)

#  define Rte_IRead_BkCpPc_Per1_PwrDiscATestStart_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscATestStart_Cnt_lgc.value)

#  define Rte_IRead_BkCpPc_Per1_PwrDiscBTestStart_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscBTestStart_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Per1_PwrDiscATestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscATestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Per1_PwrDiscATestComplete_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscATestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Per1_PwrDiscBTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscBTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Per1_PwrDiscBTestComplete_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscBTestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Per1_PwrDiscClosed_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscClosed_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Per1_PwrDiscClosed_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Per1.Rte_PwrDiscClosed_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns1_PwrDiscATestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscATestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns1_PwrDiscATestComplete_Cnt_lgc() \
  (&Rte_Task_Trans_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscATestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns1_PwrDiscBTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscBTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns1_PwrDiscBTestComplete_Cnt_lgc() \
  (&Rte_Task_Trans_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscBTestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns2_PwrDiscATestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscATestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns2_PwrDiscATestComplete_Cnt_lgc() \
  (&Rte_Task_Trans_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscATestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns2_PwrDiscBTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscBTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns2_PwrDiscBTestComplete_Cnt_lgc() \
  (&Rte_Task_Trans_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscBTestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns2_PwrDiscClosed_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscClosed_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns2_PwrDiscClosed_Cnt_lgc() \
  (&Rte_Task_Trans_10.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscClosed_Cnt_lgc.value)
...
#   if RTE_MAGIC_NUMBER != 1440005531
#    error "The magic number of the generated file <C:/_synergy/9BXX_CZ8L9T/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_BkCpPc.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1440005531
