 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Sa_MotMeclPosn2.h
...
#ifndef _RTE_SA_MOTMECLPOSN2_H
# define _RTE_SA_MOTMECLPOSN2_H
...
#  define Rte_IRead_MotMeclPosn2_Per2_MotMeclPosn2RawErrReg_Cnt_u16() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_MotMeclPosn2_MotMeclPosn2_Per2.Rte_MotMeclPosn2RawErrReg_Cnt_u16.value)

#  define Rte_IRead_MotMeclPosn2_Per2_ParityFaultAccum_Cnt_u16() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_MotMeclPosn2_MotMeclPosn2_Per2.Rte_ParityFaultAccum_Cnt_u16.value)

#  define Rte_IRead_MotMeclPosn2_Per2_UnderVltgFaultAccum_Cnt_u16() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_MotMeclPosn2_MotMeclPosn2_Per2.Rte_UnderVltgFaultAccum_Cnt_u16.value)

#  define Rte_IWrite_MotMeclPosn2_Per2_MotPosnQlfr_State_enum(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Sa_MotMeclPosn2_MotPosnQlfr_State_enum.value = (data) \
  )

#  define Rte_IWriteRef_MotMeclPosn2_Per2_MotPosnQlfr_State_enum() \
...
#  define Rte_Call_MotMeclPosn2CoeffTblBlk_GetErrorStatus(arg1) (NvMProxy_GetErrorStatus((UInt8)18, arg1), ((Std_ReturnType)RTE_E_OK))
#  define RTE_START_SEC_NVMPROXY_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_MotMeclPosn2CoeffTblBlk_WriteBlock(arg1) (NvMProxy_WriteBlock((UInt8)18, arg1))
...
#  ifdef RTE_PTR2ARRAYBASETYPE_PASSING
#   define Rte_Pim_MotMeclPosn2CoeffTblData() (&((*RtePim_MotMeclPosn2CoeffTblData())[0]))
#  else
#   define Rte_Pim_MotMeclPosn2CoeffTblData() RtePim_MotMeclPosn2CoeffTblData()
#  endif
#  define RtePim_MotMeclPosn2CoeffTblData() \
  (&Rte_Sa_MotMeclPosn2_MotMeclPosn2CoeffTblData)
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_MotMeclPosn2.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
