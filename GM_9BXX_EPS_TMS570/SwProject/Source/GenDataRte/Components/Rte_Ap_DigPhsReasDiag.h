...
#  define Rte_IRead_DigPhsReasDiag_Per1_GateDrive1ResetActive_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_DigPhsReasDiag_DigPhsReasDiag_Per1.Rte_GateDrive1ResetActive_Cnt_lgc.value)

#  define Rte_IRead_DigPhsReasDiag_Per1_GateDrive2ResetActive_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_DigPhsReasDiag_DigPhsReasDiag_Per1.Rte_GateDrive2ResetActive_Cnt_lgc.value)

#  define Rte_IRead_DigPhsReasDiag_Per1_Inverter1Inactive_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_DigPhsReasDiag_DigPhsReasDiag_Per1.Rte_Inverter1Inactive_Cnt_lgc.value)

#  define Rte_IRead_DigPhsReasDiag_Per1_Inverter2Inactive_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_DigPhsReasDiag_DigPhsReasDiag_Per1.Rte_Inverter2Inactive_Cnt_lgc.value)
...
#  define Rte_IRead_DigPhsReasDiag_Per1_MeasuredOnTimeD_Cnt_u32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_DigPhsReasDiag_DigPhsReasDiag_Per1.Rte_MeasuredOnTimeD_Cnt_u32.value)

#  define Rte_IRead_DigPhsReasDiag_Per1_MeasuredOnTimeE_Cnt_u32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_DigPhsReasDiag_DigPhsReasDiag_Per1.Rte_MeasuredOnTimeE_Cnt_u32.value)

#  define Rte_IRead_DigPhsReasDiag_Per1_MeasuredOnTimeF_Cnt_u32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_DigPhsReasDiag_DigPhsReasDiag_Per1.Rte_MeasuredOnTimeF_Cnt_u32.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_DigPhsReasDiag.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
