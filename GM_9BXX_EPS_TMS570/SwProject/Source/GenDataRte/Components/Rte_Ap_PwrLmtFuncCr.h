...
#  define Rte_IRead_PwrLmtFuncCr_Per1_AltFaultActive_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_PwrLmtFuncCr_PwrLmtFuncCr_Per1.Rte_AltFaultActive_Cnt_lgc.value)
...
#  define Rte_IRead_PwrLmtFuncCr_Per1_IvtrLoaMtgtnEn_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_PwrLmtFuncCr_PwrLmtFuncCr_Per1.Rte_IvtrLoaMtgtnEn_Cnt_lgc.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_PwrLmtFuncCr.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
