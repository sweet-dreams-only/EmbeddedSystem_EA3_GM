 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Ap_SASPlausDiag.h
...
#  define Rte_IRead_SASPlausDiag_Per1_I2CHwAbsPosValid_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_SASPlausDiag_SASPlausDiag_Per1.Rte_I2CHwAbsPosValid_Cnt_lgc.value)

#  define Rte_IRead_SASPlausDiag_Per1_I2CHwAbsPos_HwDeg_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_SASPlausDiag_SASPlausDiag_Per1.Rte_I2CHwAbsPos_HwDeg_f32.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_SASPlausDiag.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
