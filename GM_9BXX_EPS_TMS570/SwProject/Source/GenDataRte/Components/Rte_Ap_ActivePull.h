...
#  define Rte_Call_PullCmpLTComp_SetRamBlockStatus(arg1) (NvM_SetRamBlockStatus((NvM_BlockIdType)80, arg1), ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Pim_PullCmpLTComp_HwNm_f32() \
  (&Rte_Ap_ActivePull_PullCmpLTComp_HwNm_f32)
...
#    error "The magic number of the generated file <C:/02_EA3Int/9Bxx/Wip_fz9hxm/GM_9BXX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_ActivePull.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
