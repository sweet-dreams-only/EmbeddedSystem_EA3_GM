 ...
 **********************************************************************************************************************/
/* Version Control:
 * Date Created:      Tue Sep 01 11:54:05 2015
 * %version:          EA3#10 %
 * %derived_by:       fz9hxm %
 * %date_modified:    Tue Sep 01 11:54:05 2015 %
 * --------------------------------------------------------------------------------------------------------------------
...
const struct EPS_DiagSrv_PIDtbl t_DiagSrv_PIDtbl[D_DIAGSRCVS_COMPIDTBLSIZE_CNT_U16 + D_DIAGSRCVS_PROGPIDTBLSIZE_CNT_U16] =
{
	...
	{0x0007U, NULL_PTR, D_PIDTBL_VARTYPE, 0U, 0U, 0U, 0x0000U, D_PIDTBL_READONLY, D_EPSDIAGSRVXCP0007_CNT_ENUM}, /* Hw Trq */
	{0x0008U, NULL_PTR, D_PIDTBL_VARTYPE, 0U, 0U, 0U, 0x0000U, D_PIDTBL_READONLY, D_EPSDIAGSRVXCP0008_CNT_ENUM}, /* AbsHw Position (Final HW Pos) */
	...
	{0x000AU, NULL_PTR, D_PIDTBL_VARTYPE, 4U, 0U, 0U, 0x0000U, D_PIDTBL_READONLY, D_EPSDIAGSRVXCP000A_CNT_ENUM}, /* KeFBckTyH_VpRadpS_f32 */
	{0x000BU, NULL_PTR, D_PIDTBL_VARTYPE, 4U, 0U, 0U, 0x0000U, D_PIDTBL_READONLY, D_EPSDIAGSRVXCP000B_CNT_ENUM}, /* RFBckTyH_Ohm_f32 */
	...
	{0x0027U, NULL_PTR, D_PIDTBL_VARTYPE, 0U, 0U, 0U, 0x0000U, D_PIDTBL_READONLY, D_EPSDIAGSRVXCP0027_CNT_ENUM}, /* Mag Temp Estimate (DegC) */
	...
	{0x002FU, CM_MtrCurrMeas_Amp_f32, D_PIDTBL_VARTYPE, sizeof(CM_MtrCurrMeas_Amp_f32), 0U, 0U, 0x0000U, D_PIDTBL_READONLY, D_EPSDIAGSRVXCP002F_CNT_ENUM}, /* Motor Current Measurement */
	...
	{0x0053U, CM_TrqCmdScl_MRFMtrTrqCmdScl_MtrNm_f32, D_PIDTBL_VARTYPE, sizeof(CM_TrqCmdScl_MRFMtrTrqCmdScl_MtrNm_f32), 0U, 0U, 0x0000U, D_PIDTBL_READWRITE, D_EPSDIAGSRVXCP0053_CNT_ENUM}, /* Motor Torque Command Scale */
	/* Range 0x0054 to 0x00FE available for future use - (171) */
	{0x00FFU, NULL_PTR, D_PIDTBL_VARTYPE, 0U, 0U, 0U, 0x0000U, D_PIDTBL_READWRITE, D_EPSDIAGSRVXCP00FF_CNT_ENUM}, /* Digital MSB EOL Data */
	...
	/* Range 0xF019 to 0xF0FE available for future use - (230) */
	...
	/* Range 0xF100 to 0xFCDF available for future use - (3040) */
	{0xFCE0U, &EPSInternal_RID_FCE0, D_PIDTBL_RIDTYPE, 0U, 0U, 0U, 0x0009U, D_PIDTBL_READWRITE, D_EPSDIAGSRVRIDFCE0_CNT_ENUM}, /* Manufacturing Temporary Handwheel Position Offset */
	/* Range 0xFCE1 to 0xFCFF available for future use - (31) */
	...
	/* Range 0xFDCE to 0xFEDF available for future use - (274) */
	{0xFEE0U, &EPSInternal_PID_FEE0, D_PIDTBL_PIDTYPE, 20U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEE0_CNT_ENUM}, /* System Name or Engine Type */
	{0xFEE1U, &EPSInternal_PID_FEE1, D_PIDTBL_PIDTYPE, 2U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEE1_CNT_ENUM}, /* Diagnostic Data Identifier */
	{0xFEE2U, &EPSInternal_PID_FEE2, D_PIDTBL_PIDTYPE, 16U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEE2_CNT_ENUM}, /* Manufacturing Traceability (PCB Manufacturing) */
	{0xFEE3U, &EPSInternal_PID_FEE3, D_PIDTBL_PIDTYPE, 10U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEE3_CNT_ENUM}, /* Security: Seed (0xFB) and Key (0xFC) */
	{0xFEE4U, &EPSInternal_PID_FEE4, D_PIDTBL_PIDTYPE, 10U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEE4_CNT_ENUM}, /* Security: Seed (0x03) and Key (0x04) */
	{0xFEE5U, &EPSInternal_PID_FEE5, D_PIDTBL_PIDTYPE, 10U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEE5_CNT_ENUM}, /* Security: Seed (0x01) and Key (0x02) */
	{0xFEE6U, &EPSInternal_PID_FEE6, D_PIDTBL_PIDTYPE, 4U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEE6_CNT_ENUM}, /* End Model Part Number */
	{0xFEE7U, &EPSInternal_PID_FEE7, D_PIDTBL_PIDTYPE, 2U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEE7_CNT_ENUM}, /* End Model Part Number Alpha Code */
	{0xFEE8U, &EPSInternal_PID_FEE8, D_PIDTBL_PIDTYPE, 16U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEE8_CNT_ENUM}, /* Manufacturing Traceability (Nxtr) */
	/* Entry 0xFEE9 available for future use */
	{0xFEEAU, &EPSInternal_PID_FEEA, D_PIDTBL_PIDTYPE, 1U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEEA_CNT_ENUM}, /* GM Manufacturing Enable Counter (MEC) */
	{0xFEEBU, &EPSInternal_PID_FEEB, D_PIDTBL_PIDTYPE, 4U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEEB_CNT_ENUM}, /* Programming Date */
	{0xFEECU, &EPSInternal_PID_FEEC, D_PIDTBL_PIDTYPE, 10U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEEC_CNT_ENUM}, /* Repair Shop Code */
	{0xFEEDU, &EPSInternal_PID_FEED, D_PIDTBL_PIDTYPE, 17U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEED_CNT_ENUM}, /* VIN Data */
	/* Entry 0xFEEE available for future use */
	{0xFEEFU, &EPSInternal_PID_FEEF, D_PIDTBL_PIDTYPE, 2U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEEF_CNT_ENUM}, /* WIR Fault Status Information */
	/* Entry 0xFEF0 available for future use */
	{0xFEF1U, &EPSInternal_PID_FEF1, D_PIDTBL_PIDTYPE, 9U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEF1_CNT_ENUM}, /* Data Universal Numbering System Identification (DUNS) */
	/* Entry 0xFEF2 available for future use */
	{0xFEF3U, &EPSInternal_PID_FEF3, D_PIDTBL_PIDTYPE, 4U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEF3_CNT_ENUM}, /* Base Model Part Number */
	{0xFEF4U, &EPSInternal_PID_FEF4, D_PIDTBL_PIDTYPE, 2U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEF4_CNT_ENUM}, /* Base Model Part Number Alpha Code */
	{0xFEF5U, &EPSInternal_PID_FEF5, D_PIDTBL_PIDTYPE, 16U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEF5_CNT_ENUM}, /* ECU ID */
	{0xFEF6U, &EPSInternal_PID_FEF6, D_PIDTBL_PIDTYPE, 1U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEF6_CNT_ENUM}, /* Motor Variant */
	{0xFEF7U, &EPSInternal_PID_FEF7, D_PIDTBL_PIDTYPE, 2U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEF7_CNT_ENUM}, /* Limp Home Ignition Counter */
	{0xFEF8U, &EPSInternal_PID_FEF8, D_PIDTBL_PIDTYPE, 1U, 0U, 0U, 0x0001U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFEF8_CNT_ENUM} /* Get Sensor Data */
};
