 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Ap_LoaMgr.c
 *     Workspace:  C:/SynergyEA3/Working/LoaMgr/autosar
 *     SW-C Type:  Ap_LoaMgr
 *  Generated at:  Tue Jul 19 12:03:49 2016
 *
 ...
 *********************************************************************************************************************/
    ...
    LoaMgr_SnsrlsMotAgAvail_Cnt_M_lgc   = FALSE;                                                            /* REQ: SF049A #173 I */
    ...
    LoaMgr_IvtrIdptSigSV_Cnt_M_u08      = D_MAXHWTQIDPTSIGALLWD_CNT_U08;                                    /* REQ: SF049A #178 I */
 ...
 *   void Rte_IWrite_LoaMgr_Per1_LoaRateLimit_UlspS_f32(Float data)
 *   Float *Rte_IWriteRef_LoaMgr_Per1_LoaRateLimit_UlspS_f32(void)
 *   void Rte_IWrite_LoaMgr_Per1_LoaScaleFctr_Uls_f32(Float data)
 *   Float *Rte_IWriteRef_LoaMgr_Per1_LoaScaleFctr_Uls_f32(void)
 ...
 *********************************************************************************************************************/
    ...
    VAR(uint8,AUTOMATIC) Ivtr1Sts_Cnt_T_u08 = 1u;
    VAR(uint8,AUTOMATIC) Ivtr2Sts_Cnt_T_u08 = 1u;
    ...
    {
        Ivtr1Sts_Cnt_T_u08 = 0u;
    }
    if(DiagcStsIvtr2Inactv_Cnt_T_lgc == TRUE)
    {
        Ivtr2Sts_Cnt_T_u08 = 0u;
    }
    ...
    {
        (void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_LoaRpdShutdn, 0x01U, NTC_STATUS_FAILED);
    }
    else if(LoaMgr_LOASt_State_M_enum == LOAST_CTRLDSHTDWNREQD)
    {
        (void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_LoaCtrldShutdn, 0x01U, NTC_STATUS_FAILED);
    }
    else
    {
    }
    ...
    /* REQ: SF049A #127 I */
    if(HwTqIdptSig_Cnt_T_u08 <= k_LoaMgr_HwTqIdptSigFltThd_Cnt_u08)
    {
        (void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_LoaMgr_HwTqIdptSigTooLow, 0x01U, NTC_STATUS_FAILED);
    }
    /* ENDREQ: SF049A #127 I */
    /* REQ: SF049A #136 I */
    if(MtrPosIdptSig_Cnt_T_u08 <= k_LoaMgr_MotAgIdptSigFltThd_Cnt_u08)
    {
        (void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_LoaMgr_MotAgIdptSigTooLow, 0x01U, NTC_STATUS_FAILED);
    }
    /* ENDREQ: SF049A #136 I */
    /* REQ: SF049A #145 I */
    if(MotCurrIdptSig_Cnt_T_u08 <= k_LoaMgr_MotCurrIdptSigFltThd_Cnt_u08)
    {
        (void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_LoaMgr_MotCurrIdptSigTooLow, 0x01U, NTC_STATUS_FAILED);
    }
    /* ENDREQ: SF049A #145 I */
    /* REQ: SF049A #154 I */
    if(IvtrIdptSig_Cnt_T_u08 <= k_LoaMgr_IvtrIdptSigFltThd_Cnt_u08)
    {
        (void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_LoaMgr_IvtrIdptSigTooLow, 0x01U, NTC_STATUS_FAILED);
    }  
    /* ENDREQ: SF049A #154 I */
    /* Assign Scale */
    ...
    Rte_IWrite_LoaMgr_Per1_LoaRateLimit_UlspS_f32(LoaMgr_LoaRateLimit_UlspS_M_f32);         /* REQ: SF049A #18 I */
    Rte_IWrite_LoaMgr_Per1_LoaScaleFctr_Uls_f32(LoaMgr_LoaScaleFctr_Uls_M_f32);             /* REQ: SF049A #17 I */
...
/*******************************************************************************
 ...
 STATIC FUNC(void, AP_LOAMGR_APPL_CODE) ChooseFinalResp(VAR(uint8, AUTOMATIC) MultiMtgtnResp_Cnt_T_u08)
 {
    ...
    {       
        ...
        break;
        case 4u:/* F1 Controlled Shutdown */
            LoaMgr_LOASt_State_M_enum = LOAST_CTRLDSHTDWNREQD;
        break;
        case 5u:/* F2 Immediate Shutdown most severe)*/
