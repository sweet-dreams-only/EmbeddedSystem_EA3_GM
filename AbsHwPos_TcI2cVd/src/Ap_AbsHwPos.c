 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Ap_AbsHwPos.c
 *     Workspace:  C:/_Synergy_Projects/Working/AbsHwPos_TcI2cVd-nz63rn/AbsHwPos_TcI2cVd/autosar
 *     SW-C Type:  Ap_AbsHwPos
 *  Generated at:  Mon Nov 25 14:38:28 2013
 *
...
#define D_SRCLOSPDVD_CNT_U16            0x03U
#define D_SRCHISPDVD_CNT_U16            0x04U
...
STATIC VAR(boolean, AP_ABSHWPOS_VAR) AbsHwPos_VehCntrOfstLearn_Cnt_M_lgc;
STATIC VAR(boolean, AP_ABSHWPOS_VAR) AbsHwPos_MtrToHwAOfstLearnt_Cnt_M_lgc;
...
STATIC VAR(uint16, AP_ABSHWPOS_VAR) AbsHwPos_HwAtoMtrAFltAcc_Cnt_M_u16;
...
STATIC VAR(float32, AP_ABSHWPOS_VAR) AbsHwPos_PrevHandwheelPosition_HwDeg_M_f32;
STATIC VAR(float32, AP_ABSHWPOS_VAR) AbsHwPos_HandwheelAuthority_Uls_M_f32;
STATIC VAR(float32, AP_ABSHWPOS_VAR) AbsHwPos_TempHwPos_HwDeg_M_f32;
STATIC VAR(float32, AP_ABSHWPOS_VAR) AbsHwPos_SrlComHwPos_HwDeg_M_f32;
STATIC VAR(float32, AP_ABSHWPOS_VAR) AbsHwPos_TargetHwAuthority_Uls_M_f32;
STATIC VAR(float32, AP_ABSHWPOS_VAR) AbsHwPos_RelHwPos_HwDeg_M_f32;
STATIC VAR(float32, AP_ABSHWPOS_VAR) AbsHwPos_MtrtoHwAOfst_HwDeg_M_f32;
 ...
 *   Float Rte_IRead_AbsHwPos_Per2_VdAuthority_Uls_f32(void)
 *   Float Rte_IRead_AbsHwPos_Per2_VdHwPos_HwDeg_f32(void)
 *
 * Output Interfaces:
 * ==================
 *   Implicit S/R API:
 ...
 *********************************************************************************************************************/
    ...
    VdAuthority_Uls_T_f32 = Rte_IRead_AbsHwPos_Per2_VdAuthority_Uls_f32();
    VdHwPos_HwDeg_T_f32 = Rte_IRead_AbsHwPos_Per2_VdHwPos_HwDeg_f32();
        ...
        else
        {
            if (TurnsCntrValidity_Cnt_T_u08 == D_TCVVALID_CNT_U08)
            {
                if (AbsHwPos_VehCntrValid_Cnt_M_lgc == TRUE)
                {
                    ...
                    if (VdAuthority_Uls_T_f32 >= k_HiSpdVDAuthority_Uls_f32)
                    {
                ...
                {
                    if (VdAuthority_Uls_T_f32 >= k_LoSpdVDAuthority_Uls_f32)
                    {
                        /* ES-05G v002 - Section 5.1.2.2.3 - Column 4 Top */
                        AbsHwPos_SrlComHwPosStatus_Cnt_M_u16 = D_HWPOSSTATUSVALID_CNT_U16;
                        AbsHwPos_TempHwPos_HwDeg_M_f32 = VdHwPos_HwDeg_T_f32;
                        AbsHwPos_TargetHwAuthority_Uls_M_f32 = VdAuthority_Uls_T_f32;
						
                        if (VdAuthority_Uls_T_f32 >= k_HiSpdVDAuthority_Uls_f32)
                        {
                            /* ES-05G v002 - Section 5.1.2.2.3 - Column 4 Bottom Left */
                            AbsHwPos_HwPosSource_Cnt_M_u16 = D_SRCHISPDVD_CNT_U16;
                            AbsHwPos_VehCntrOfstLearn_Cnt_M_lgc = TRUE;
                        }
                        else
                        {
                            /* ES-05G v002 - Section 5.1.2.2.3 - Column 4 Bottom Right */
                            AbsHwPos_HwPosSource_Cnt_M_u16 = D_SRCLOSPDVD_CNT_U16;
                            AbsHwPos_VehCntrOfstLearn_Cnt_M_lgc = FALSE;
                        }
                    }
                    else
    ...
    else if (AbsHwPos_HwPosState_Cnt_M_enum == HWPOS_STATE_SENSORINVALID)
    {
        ...
        else
        {
            ...
            if (VdAuthority_Uls_T_f32 >= k_LoSpdVDAuthority_Uls_f32)
            {
                ...
                if (VdAuthority_Uls_T_f32 >= k_HiSpdVDAuthority_Uls_f32)
                {
                    /* ES-05G v002 - Section 5.1.2.2.2 - Column 3 Bottom Left */
                    AbsHwPos_HwPosSource_Cnt_M_u16 = D_SRCHISPDVD_CNT_U16;
                }
                else
                {
                    /* ES-05G v002 - Section 5.1.2.2.2 - Column 3 Bottom Right */
                    AbsHwPos_HwPosSource_Cnt_M_u16 = D_SRCLOSPDVD_CNT_U16;
                }
            }
            else
    ...
    {
        VehCntrOffset_HwDeg_T_f32 = AbsHwPos_AlignedCumMtrPos_HwDeg_M_f32 - VdHwPos_HwDeg_T_f32;
