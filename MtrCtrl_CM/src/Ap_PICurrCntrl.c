...
* Nxtr Confidential
*
* Module File Name  : Ap_PICurrCntrl.c
* Module Description: Proportional Integral Control Implementation
* Project           : CBD
...
* ---------  -------  ---------  --------------------------------------------------------------------------  ----------
* 02/02/12    1         RR       Initial Creation                                                             N/A
* 03/07/12    2         RR       Changes to ComOffset during offset Srv                                       N/A
* 04/18/12    3         RR       Changes for IPM
...
* 03/10/16    15        Selva    Updated for V18 of FDD SF99B                                                 EA3#6525
* 07/21/16    16        Rijvi    Updated for V19 of FDD SF99B                                                 EA3#9293
* 01/03/17    17        SR       Updated for V20 of FDD SF99B                                                 EA3#13142
******************************************************************************/
...
FUNC(void, PICurrCntrl_CODE) PICurrCntrl_Per1(void)
{
    ...
    /* I error Calculation */
    /* MtrCurrQAXErrorCalc*/
    MtrCurrQaxFinalRef_Amp_T_f32 = MtrCurrQaxRef_Amp_T_f32 - MtrCtrl_MtrCurrQaxCogRpl_Amp_M_f32;
    ...
    {
        MtrCurrQaxRefModif_Amp_T_f32  =  (PICurrCntrl_MtrCurrQaxSatFluxRatio_Uls_M_f32 *  MtrCurrQaxRef_Amp_T_f32) - MtrCtrl_MtrCurrQaxCogRpl_Amp_M_f32;
    }
    ...
    {
        PhaseAdvanceFinal_Rev_T_u0p16 = (uint16)(uint32)(float32)((PhaseAdvanceFinal_Rad_T_f32 * D_SCALERADTOCNTS_ULS_F32) + D_REVWITHROUND_ULS_F32);
    }
    else
    {
        PhaseAdvanceFinal_Rev_T_u0p16 = (uint16)(uint32)(float32)((PhaseAdvanceFinal_Rad_T_f32 * D_SCALERADTOCNTS_ULS_F32) + D_ROUND_ULS_F32);
    }
    ...
    CommOffset_Cnt_T_u16  = IntplVarXY_u16_u16Xu16Y_Cnt(t_CommOffsetTblX_Uls_u3p13,
 ...
 *              IvtrLoaMtgtnEn_Cnt_T_lgc        - Inverter LOA Enable
 *              DualEcuMotCtrlMtgnEna_Cnt_T_lgc - Dual Ecu MotCtrl Mtgn Enable
 * Outputs:     PICurrCntrl_DualEcuFailSclFac_Uls_M_f32,
 *              PICurrCntrl_InverterFailSclFac_Uls_M_f32,
 *              PICurrCntrl_CurrSensFailSclFac_Uls_M_f32
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(void, AP_CurrCmd_VAR_NOINIT) LoaMtgtnSclFac( VAR(boolean, AUTOMATIC) MotCurrLoaMtgtnEn_Cnt_T_lgc, VAR(boolean, AUTOMATIC) IvtrLoaMtgtnEn_Cnt_T_lgc, VAR(boolean, AUTOMATIC) DualEcuMotCtrlMtgnEna_Cnt_T_lgc )
{
 ...
 * Inputs:      SysState_Cnt_T_Enum - System state
 * Outputs:     None
 * Usage Notes: None 
 ****************************************************************************/
