 ...
 *********************************************************************************************************************/
 ...
 /*****************************************************************************
* Copyright 2017-15,2013-12 Nxtr 
* Nxtr Confidential
*
* Module File Name  : Ap_TrqCanc.c
* Module Description: Torque Ripple Cancellation implementation
* Project           : CBD
...
* 02/24/13    9      M.Story   Anomaly 4342 cogtorq read write fixed                                   
* 02/24/13    11     Selva     Updated for SF99B -v8 with only changes needed for                      
*                              voltage command integrity check for torque reasonableness               
...
* 01/03/17    22     SR        Updated for V20 of FDD SF99B. Alignment & comments rework done.         EA3#13142
* 03/06/17    18     SR        Updated for fixing anomaly EA3#14037                                    EA3#14387
******************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  */
  ...
  /* MISRA-C:2004 Rule 8.7 : Objects shall be defined at block scope if they are only accessed from within a single function. *
   * Rationale: Deviation needed to keep the memory map intact. */

  /* PRQA S 4393 EOF *
   * MISRA-C:2004 Rule 10.3 : A composite expression of 'essentially signed' type is being cast to a different type category. *
   * Rationale: Deviation required due to use of Nxtr macro library functions. */

  /* PRQA S 4395 EOF *
   * MISRA-C:2004 Rule 10.4: A composite expression of 'essentially floating' type is being cast to a different type category. *
   * Rationale: Deviation required due to use of Nxtr macro library functions. */

  /* PRQA S 4533 EOF *
   * MISRA-C:2004 Rule 12.7: An expression of 'essentially signed' type is  used as the left-hand operand of this shift operator. *
   * Rationale: This deviation is required because of Nxtr macro library. */
 ...
 #define D_NOOFHARMONIC_CNT_U8    2U
 ...
 /* Module Variables - local to file*/
 ...
 /* Module Variables - externed in header file*/
 VAR(float32, AP_CurrParamComp_VAR_NOINIT) MtrCtrl_MtrCurrQaxCogRpl_Amp_M_f32;
 ...
 STATIC volatile VAR(uint16, Ap_TrqCanc_VAR_NOINIT) MtrTrqCancRampDown6thScl_Uls_D_u0p16;  /* PRQA S 3218 */
 STATIC volatile VAR(uint16, Ap_TrqCanc_VAR_NOINIT) MtrTrqCancRampDown12thScl_Uls_D_u0p16; /* PRQA S 3218 */
 /* Module Variables - local to file*/
 ...
 *********************************************************************************************************************/
    ...
    VAR(uint16 , AUTOMATIC) MtrTrqCancRampDown6thScl_Uls_T_u0p16;
    VAR(uint16 , AUTOMATIC) MtrTrqCancRampDown12thScl_Uls_T_u0p16;
    ...
    MtrTrqCmdMRFScl_MtrNm_T_s4p11= FPM_FloatToFixed_m(MtrTrqCmdMRFScl_MtrNm_T_f32,s4p11_T);

    /* 6thMag_TrqRipple */
    MtrTrqRpl6X_MtrNm_T_s2p13 = BilinearXYM_s16_u16Xs16YM_Cnt(Abs_s16_m(DaxRef_Amp_T_s8p7),
    ...
    /* 6thPhase_TrqRipple */
    MtrTrqRpl6Y_MtrNm_T_s2p13 = BilinearXYM_s16_u16Xs16YM_Cnt(Abs_s16_m(DaxRef_Amp_T_s8p7),
                                                              Abs_s16_m(QaxRef_Amp_T_s8p7),
                                                              t_MtrCurrDaxRpl_Amp_u9p7,
                                                              TableSize_m(t_MtrCurrDaxRpl_Amp_u9p7),
                                                              t_MtrCurrQaxRpl_Amp_u9p7,
    ...
    /* 12thMag_TrqRipple */
    MtrTrqRpl12X_MtrNm_T_s2p13 = BilinearXYM_s16_u16Xs16YM_Cnt(Abs_s16_m(DaxRef_Amp_T_s8p7),
                                                               Abs_s16_m(QaxRef_Amp_T_s8p7),
                                                               t_MtrCurrDaxRpl_Amp_u9p7,
                                                               TableSize_m(t_MtrCurrDaxRpl_Amp_u9p7),
                                                               t_MtrCurrQaxRpl_Amp_u9p7,
    ...
    /* 12thPhase_TrqRipple */
    MtrTrqRpl12Y_MtrNm_T_s2p13 = BilinearXYM_s16_u16Xs16YM_Cnt(Abs_s16_m(DaxRef_Amp_T_s8p7),
                                                               Abs_s16_m(QaxRef_Amp_T_s8p7),
                                                               t_MtrCurrDaxRpl_Amp_u9p7,
                                                               TableSize_m(t_MtrCurrDaxRpl_Amp_u9p7),
                                                               t_MtrCurrQaxRpl_Amp_u9p7,
    ...
    MtrTrqCancPI6thMagRP_Uls_T_u6p10 = BilinearXYM_u16_u16Xu16YM_Cnt(MtrVel6thHarm_MtrRadpS_T_u16,
                                                                     Abs_s16_m(MtrTrqCmdMRFScl_MtrNm_T_s4p11),
    ...
    MtrTrqCancPI6thPhRP_Rev_T_u0p16 = BilinearXYM_u16_u16Xu16YM_Cnt(MtrVel6thHarm_MtrRadpS_T_u16,
                                                                    Abs_s16_m(MtrTrqCmdMRFScl_MtrNm_T_s4p11),
                                                                    t_MtrVelX_MtrRadpS_T_u16,
                                                                    TableSize_m(t_MtrVelX_MtrRadpS_T_u16),
                                                                    t_MtrTrqCmdPIY_MtrNm_u5p11,
    ...
    MtrTrqCancPI12thMagRP_Uls_T_u6p10 = BilinearXYM_u16_u16Xu16YM_Cnt(MtrVel12thHarm_MtrRadpS_T_u16,
                                                                      Abs_s16_m(MtrTrqCmdMRFScl_MtrNm_T_s4p11),
                                                                      t_MtrVelX_MtrRadpS_T_u16,
                                                                      TableSize_m(t_MtrVelX_MtrRadpS_T_u16),
                                                                      t_MtrTrqCmdPIY_MtrNm_u5p11,
    ...
    MtrTrqCancPI12thPhRP_Rev_T_u0p16 = BilinearXYM_u16_u16Xu16YM_Cnt(MtrVel12thHarm_MtrRadpS_T_u16,
                                                                     Abs_s16_m(MtrTrqCmdMRFScl_MtrNm_T_s4p11),
                                                                     t_MtrVelX_MtrRadpS_T_u16,
                                                                     TableSize_m(t_MtrVelX_MtrRadpS_T_u16),
                                                                     t_MtrTrqCmdPIY_MtrNm_u5p11,
    ...
    /* Calculate Ramp Down Scale Factors to handle compensation near voltage limits
    */
    MtrTrqCancRampDown6thScl_Uls_T_u0p16 = IntplVarXY_u16_u16Xu16Y_Cnt(t_TrqRplCogRampDownVoltSatX_Uls_u0p16,
                                                                       t_TrqRplCogRampDown6thY_Uls_u0p16,
                                                                       (uint16)TableSize_m(t_TrqRplCogRampDownVoltSatX_Uls_u0p16),
                                                                       FPM_FloatToFixed_m(MtrCtrl_VoltSatIndicFf_Uls_M_f32,u0p16_T));

    MtrTrqCancRampDown12thScl_Uls_T_u0p16 = IntplVarXY_u16_u16Xu16Y_Cnt(t_TrqRplCogRampDownVoltSatX_Uls_u0p16,
                                                                        t_TrqRplCogRampDown12thY_Uls_u0p16,
                                                                        (uint16)TableSize_m(t_TrqRplCogRampDownVoltSatX_Uls_u0p16),
                                                                        FPM_FloatToFixed_m(MtrCtrl_VoltSatIndicFf_Uls_M_f32,u0p16_T));

    MtrTrqCancRampDown6thScl_Uls_D_u0p16  = MtrTrqCancRampDown6thScl_Uls_T_u0p16;
    MtrTrqCancRampDown12thScl_Uls_D_u0p16 = MtrTrqCancRampDown12thScl_Uls_T_u0p16;

    /* Ramp down magnitude based on calculated scale factor*/
    MtrTrqCancPI6thMagRP_Uls_T_f32  = MtrTrqCancPI6thMagRP_Uls_T_f32  * (FPM_FixedToFloat_m(MtrTrqCancRampDown6thScl_Uls_T_u0p16,u0p16_T));
    MtrTrqCancPI12thMagRP_Uls_T_f32 = MtrTrqCancPI12thMagRP_Uls_T_f32 * (FPM_FixedToFloat_m(MtrTrqCancRampDown12thScl_Uls_T_u0p16,u0p16_T));
    ...
    MtrTrq6thMag_MtrNm_T_f32=Limit_m((MtrTrqCancPI6thMagRP_Uls_T_f32*MtrTrq6thMagInt_MtrNm_T_f32), D_ZERO_ULS_F32, D_MAXTRQRANGE_NM_F32);
    MtrTrqRip6thPhs_Rad_T_f32=MtrTrqCancPI6thPhRPTemp_Rad_T_f32 + MtrTrqRip6thPhsTemp_Rad_T_f32;

    MtrTrq12thMag_MtrNm_T_f32=Limit_m((MtrTrqCancPI12thMagRP_Uls_T_f32*MtrTrq12thMagInt_MtrNm_T_f32), D_ZERO_ULS_F32, D_MAXTRQRANGE_NM_F32);
...
STATIC FUNC(void, AUTOMATIC )  CoggingTrqTableUpdate( void)
{
    ...
    VAR(uint16,  AUTOMATIC) LoopCnt1_T_Cnt_u16,LoopCnt2_T_Cnt_u16;
    ...
    Ignore the values at index 0, 3, 6, 7, 8
    ***/
    for (LoopCnt1_T_Cnt_u16=0u ; LoopCnt1_T_Cnt_u16 < D_NOOFHARMONIC_CNT_U8; LoopCnt1_T_Cnt_u16++)
    {
        CogTrqCalCompX_T_MtrNm_s2p13 = FPM_Fix_m((sint16)((*(Rte_Pim_CogTrqRplComp()))[1u+(3u*LoopCnt1_T_Cnt_u16) ]),s5p10_T, s2p13_T);     /* PRQA S 4394 */
        CogTrqCalCompX_T_MtrNm_s2p13 = Limit_m(CogTrqCalCompX_T_MtrNm_s2p13,D_MINCOGRANGE_NM_S2P13, D_MAXCOGRANGE_NM_S2P13);
        CogTrqCalComp_T_Cnt_str[LoopCnt1_T_Cnt_u16].CoggingMX_MtrNm_s2p13 = CogTrqCalCompX_T_MtrNm_s2p13;
        CogTrqCalCompY_T_MtrNm_s2p13 = FPM_Fix_m((sint16)((*(Rte_Pim_CogTrqRplComp()))[2u + (LoopCnt1_T_Cnt_u16*3u)]),s5p10_T, s2p13_T);    /* PRQA S 4394 */
        CogTrqCalCompY_T_MtrNm_s2p13 = Limit_m(CogTrqCalCompY_T_MtrNm_s2p13,D_MINCOGRANGE_NM_S2P13, D_MAXCOGRANGE_NM_S2P13);
        CogTrqCalComp_T_Cnt_str[LoopCnt1_T_Cnt_u16].CoggingMY_MtrNm_s2p13 =CogTrqCalCompY_T_MtrNm_s2p13;
    }

    for (LoopCnt1_T_Cnt_u16=0u;LoopCnt1_T_Cnt_u16<D_DAXRPLTBLSZ_CNT_U8;LoopCnt1_T_Cnt_u16++)
    {
        for (LoopCnt2_T_Cnt_u16=0u; LoopCnt2_T_Cnt_u16<D_QAXRPLTBLSZ_CNT_U8;LoopCnt2_T_Cnt_u16++)
        {
            TrqCanc_MtrTrqRpl6X_MtrNm_M_s2p13[LoopCnt1_T_Cnt_u16][LoopCnt2_T_Cnt_u16]  = t2_MtrTrqRpl6X_MtrNm_s2p13[LoopCnt1_T_Cnt_u16][LoopCnt2_T_Cnt_u16]  + CogTrqCalComp_T_Cnt_str[0].CoggingMX_MtrNm_s2p13;
            TrqCanc_MtrTrqRpl6Y_MtrNm_M_s2p13[LoopCnt1_T_Cnt_u16][LoopCnt2_T_Cnt_u16]  = t2_MtrTrqRpl6Y_MtrNm_s2p13[LoopCnt1_T_Cnt_u16][LoopCnt2_T_Cnt_u16]  + CogTrqCalComp_T_Cnt_str[0].CoggingMY_MtrNm_s2p13;
            TrqCanc_MtrTrqRpl12X_MtrNm_M_s2p13[LoopCnt1_T_Cnt_u16][LoopCnt2_T_Cnt_u16] = t2_MtrTrqRpl12X_MtrNm_s2p13[LoopCnt1_T_Cnt_u16][LoopCnt2_T_Cnt_u16] + CogTrqCalComp_T_Cnt_str[1].CoggingMX_MtrNm_s2p13;
            TrqCanc_MtrTrqRpl12Y_MtrNm_M_s2p13[LoopCnt1_T_Cnt_u16][LoopCnt2_T_Cnt_u16] = t2_MtrTrqRpl12Y_MtrNm_s2p13[LoopCnt1_T_Cnt_u16][LoopCnt2_T_Cnt_u16] + CogTrqCalComp_T_Cnt_str[1].CoggingMY_MtrNm_s2p13;
        }
    }
}
...
FUNC(void, TrqCanc_CODE) TrqCogCancRefPer1(void)
{
    ...
    MtrTrqRpl_MtrNm_T_f32=((MtrTrqRpl6Mag_MtrNm_T_f32*SinLookup(MtrPos6thHarAngle_Rad_T_f32))+(MtrTrqRpl12Mag_MtrNm_T_f32*SinLookup(MtrPos12thHarAngle_Rad_T_f32)));
    TrqCanc_MtrTrqRpl_MtrNm_D_f32= MtrTrqRpl_MtrNm_T_f32;
        
    /* Updating glbal variable buffers*/
    MtrCtrl_MtrCurrQaxCogRpl_Amp_M_f32 = ((MtrTrqRpl_MtrNm_T_f32+CoggingTrqCanc_MtrNm_T_f32)/IqtoTrqMulti_VpRadpS_T_f32);
