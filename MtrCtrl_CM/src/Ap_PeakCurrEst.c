...
* Nxtr Confidential
*
* Module File Name  : Ap_PeakCurrEst.c
* Module Description: Estimate Peak Current
* Project           : CBD
...
* 03/21/12    4        Selva       Updated to version 8 FDD SF99B                                             7711
* 03/10/15    5        Selva       Updated for V15 of FDD SF99B                                               12888
* 07/21/16    6        Rijvi       Updated for V19 of FDD SF99B                                               EA3#9293
* 01/03/17    7        SR          Regenerated file and corrected for:                                        EA3#13142
*                                  QAC suppression & MISRA deviation comments, Alignment corrections
******************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  */
  ...
  /* MISRA-C:2004 Rule 3.1: Casting to a signed integer type of insufficient size.
   * Rationale: Deviation is allowed till decision is made about fixing the warnings in Nxtr Libraries. */
  ...
  /* MISRA-C:2004 Rule 21.1: Deviation is allowed till decision is made about fixing the warnings in Nxtr Libraries. 
