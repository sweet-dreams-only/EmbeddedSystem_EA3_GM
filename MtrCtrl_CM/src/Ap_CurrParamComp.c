 ...
 *  Generated at:  Mon Dec 19 15:40:14 2016
 *
...
/*****************************************************************************
* Copyright 2017-16,2013-12 Nxtr 
* Nxtr Confidential
*
* Module File Name  : Ap_CurrParamComp.c
* Module Description: Current Parameter Compensation calculation
* Project           : CBD
...
* 10/21/13    10        Selva      Updated to version 10 FDD SF99 B. Divide by zero issue fixed              10050
* 11/06/13    11        Selva      Updated for V11 of FDD SF99 B                                             10740
* 07/26/16    12        Rijvi      Updated for V19 of FDD SF99B                                              EA3#9293
* 01/03/17    13        SR         Updated for V20 of FDD SF99B                                              EA3#13142
******************************************************************************/
 ...
 *********************************************************************************************************************/
 ...
 /* MISRA-C 2004 Rule 11.4: Casting to different pointer type should not be done.
  * Rationale: Deviation needed to pass 2D table to bilinear interpolation library function. */
 ...
 /* Display variables */
 STATIC volatile VAR(float32, AP_CurrParamComp_VAR_NOINIT) KeSatSclFac_Uls_D_f32;      /* PRQA S 3218 */
 STATIC volatile VAR(float32, AP_CurrParamComp_VAR_NOINIT) KeSatSclFacAdj_Uls_D_f32;   /* PRQA S 3218 */
 STATIC volatile VAR(float32, AP_CurrParamComp_VAR_NOINIT) LqSatSclFac_Uls_D_f32;      /* PRQA S 3218 */
 STATIC volatile VAR(float32, AP_CurrParamComp_VAR_NOINIT) LdSatSclFac_Uls_D_f32;      /* PRQA S 3218 */
 STATIC volatile VAR(float32, AP_CurrParamComp_VAR_NOINIT) EstRfetFF_Ohm_D_f32;        /* PRQA S 3218 */
 STATIC volatile VAR(float32, AP_CurrParamComp_VAR_NOINIT) EstRmtrFF_Ohm_D_f32;        /* PRQA S 3218 */
 STATIC volatile VAR(float32, AP_CurrParamComp_VAR_NOINIT) PreLmtEstKe_VpRadpS_D_f32;  /* PRQA S 3218 */
 STATIC volatile VAR(float32, AP_CurrParamComp_VAR_NOINIT) PreLmtEstR_Ohm_D_f32;       /* PRQA S 3218 */
 STATIC volatile VAR(float32, AP_CurrParamComp_VAR_NOINIT) PreLmtEstLq_Henry_D_f32;    /* PRQA S 3218 */
 STATIC volatile VAR(float32, AP_CurrParamComp_VAR_NOINIT) PreLmtEstLd_Henry_D_f32;    /* PRQA S 3218 */
 ...
 *   Implicit S/R API:
 *   -----------------
 *   Boolean Rte_IRead_CurrParamComp_Per1_DualEcuFltMtgtnEna_Cnt_lgc(void)
 *   Boolean Rte_IRead_CurrParamComp_Per1_IvtrLoaMtgtnEn_Cnt_lgc(void)
 ...
 *********************************************************************************************************************/
    ...
    VAR(float32, AUTOMATIC) KeSatSclFacAdj_Uls_T_f32;
    ...
    DualEcuFltMtgtnEna_Cnt_T_lgc = Rte_IRead_CurrParamComp_Per1_DualEcuFltMtgtnEna_Cnt_lgc();
    IvtrLoaMtgtnEna_Cnt_T_lgc = Rte_IRead_CurrParamComp_Per1_IvtrLoaMtgtnEn_Cnt_lgc();
    ...
    /**** Adjust the scale factor based on IvtrLoaMtgnEna and DualEcuFltMtgtnEna ****/
    if((IvtrLoaMtgtnEna_Cnt_T_lgc    != FALSE) || 
       (DualEcuFltMtgtnEna_Cnt_T_lgc != FALSE))
    {
        KeSatSclFacAdj_Uls_T_f32 = 1.0F - ((1.0F - KeSatSclFac_Uls_T_f32)*k_KeSatSclAdj_Uls_f32);
        EstLq_Henry_T_f32 = k_NomLqFltAdj_Henry_f32 * LqSatSclFac_Uls_T_f32;
        EstLd_Henry_T_f32 = k_NomLdFltAdj_Henry_f32 * LdSatSclFac_Uls_T_f32;
    }
    else
    {
        KeSatSclFacAdj_Uls_T_f32 = KeSatSclFac_Uls_T_f32;
        EstLq_Henry_T_f32 = k_NomLq_Henry_f32 * LqSatSclFac_Uls_T_f32;
        EstLd_Henry_T_f32 = k_NomLd_Henry_f32 * LdSatSclFac_Uls_T_f32;
    }
    KeSatSclFacAdj_Uls_D_f32 = KeSatSclFacAdj_Uls_T_f32;

    /**** Feedforward path estimation ****/
    EstKe_VpRadpS_T_f32 = (EstKeFF_VpRadpS_M_f32 * KeSatSclFacAdj_Uls_T_f32);
