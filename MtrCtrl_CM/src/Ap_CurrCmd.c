...
* Nxtr Confidential
*
* Module File Name   : Ap_CurrCmd.c
* Module Description : Generates the Current Command and the Voltage Reference for the Current Control
* Project            : CBD
...
* 03/21/13   6,7    Selva     Updated to version 8 FDD SF99                                            7711
...
* 01/03/17   17     SR        Updated for V20 of FDD SF99B. Updated version control block             EA3#13142
*                             Updated formats & comments to match coding standards v2.1
 ...
 *********************************************************************************************************************/
  ...
  */
  ...
  /* MISRA-C:2004 Rule 17.4 : Array subscripting applied to a function parameter declared as a pointer. *
   * Rationale: Deviated required because arrays being passed as pointers to functions. */
 ...
 VAR(float32, AUTOMATIC) MtrCtrl_VoltSatIndicFf_Uls_M_f32;
 ...
 *********************************************************************************************************************/
    ...
    MRFMtrVelFiltFF_MtrRadpS_T_s11p4 =  FPM_FloatToFixed_m(MRFMtrVelFiltFF_MtrRadpS_T_f32,s11p4_T);
    ...
    MRFMtrVelFiltPI_MtrRadpS_T_s11p4 = FPM_FloatToFixed_m(MRFMtrVelFiltPI_MtrRadpS_T_f32,s11p4_T);
    ...
    MRFMtrVelFiltPI_MtrRadpS_T_u12p4 =(uint16)(Abs_s16_m(MRFMtrVelFiltPI_MtrRadpS_T_s11p4));
    ...
    if ((MtrQuad_Cnt_T_u8 == D_QUADRANT1_CNT_U8 )|| (MtrQuad_Cnt_T_u8 == D_QUADRANT3_CNT_U8 ))
    {
        VltgSched_Volt_T_u5p11 = IntplVarXY_u16_u16Xu16Y_Cnt(t_Q13VltgSchedXTbl_MtrRadpS_u12p4, 
                                                             ...
                                                             Abs_s16_m(MRFMtrVelFiltFF_MtrRadpS_T_s11p4));
    }
    else
    {
    ...
    MtrCurrDaxRef_Amp_T_f32=Limit_m(MtrCurrDaxRef_Amp_T_f32, D_ZERO_ULS_F32      ,D_MAXCURRENT_AMP_F32);
    ...
    MtrVoltDaxFFVoltMode_Volt_T_f32 = Limit_m(MtrVoltDaxFFVoltMode_Volt_T_f32, -D_VECUMAX_VOLTS_F32, D_VECUMAX_VOLTS_F32);
    MtrVoltQaxFFVoltMode_Volt_T_f32 = Limit_m(MtrVoltQaxFFVoltMode_Volt_T_f32, -D_VECUMAX_VOLTS_F32, D_VECUMAX_VOLTS_F32);
    
    /*Ratio of Magnitude of Voltage calculated to be applied to available Supply voltage*/
    MtrCtrl_VoltSatIndicFf_Uls_M_f32 = (__sqrtf((MtrVoltDaxFFVoltMode_Volt_T_f32*MtrVoltDaxFFVoltMode_Volt_T_f32) +
                                               (MtrVoltQaxFFVoltMode_Volt_T_f32*MtrVoltQaxFFVoltMode_Volt_T_f32)) / VsupplyAvail_Volt_T_f32);

    /* Write Rte o/p */
    Rte_IWrite_CurrCmd_Per1_MtrVoltDaxFFStatic_Volt_f32( MtrVoltDaxFFVoltMode_Volt_T_f32 );
    Rte_IWrite_CurrCmd_Per1_MtrVoltQaxFFStatic_Volt_f32( MtrVoltQaxFFVoltMode_Volt_T_f32 );
 ...
 * Description: Perform Parabolic Interpolation of given array of value
 ...
 * Description: Calculate the ImVSIdq signal value from inputs
 * Inputs:      IdRef_Amp_T_f32,IqRef_Amp_T_f32
 * Outputs:     ImVSIdq_AmpSq_T_f32
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(float32, AP_CurrCmd_VAR_NOINIT) CalculateImVSIdq( VAR(float32, AUTOMATIC)IdRef_Amp_T_f32,
                                                              VAR(float32, AUTOMATIC)IqRef_Amp_T_f32)
{
...
/******************************************************************************
 * Name:        CalculateIq
 * Description: Calculate the IqRef current value from inputs
 * Inputs:      Torquecmd_MtrNm_T_f32, IdRef_Amp_T_f32
 * Outputs:     IqRef_Amp_T_f32
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(float32, AP_CurrCmd_VAR_NOINIT) CalculateIq(VAR(float32, AUTOMATIC) Torquecmd_MtrNm_T_f32,
                                                        VAR(float32, AUTOMATIC) IdRef_Amp_T_f32)
{
...
/******************************************************************************
 * Name:        CurrtoVoltTest
 * Description: Test if Vdq magnitude is greater than TermVR2
 * Inputs:      MtrTrqCmd_MtrNm_T_f32,IqRef_Amp_T_f32,IdRef_Amp_T_f32
 * Outputs:     VqR_Amp_T_f32,VdR_Amp_T_f32,VoltTest_Uls_T_lgc
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(Boolean, AP_CurrCmd_VAR_NOINIT) CurrtoVoltTest(VAR(float32, AUTOMATIC) IqRef_Amp_T_f32,
                                                           VAR(float32, AUTOMATIC) IdRef_Amp_T_f32,
                                                           P2VAR(float32, AUTOMATIC, AUTOMATIC) VdR_Amp_T_f32,
                                                           P2VAR(float32, AUTOMATIC, AUTOMATIC) VqR_Amp_T_f32)
{
...
/******************************************************************************
 * Name:        CalcTorque
 * Description: Calculate Torque and max current on Id axis
 * Inputs:      CosDelta_Cnt_T_f32, SinDelta_Cnt_T_f32
 * Outputs:     IdMax_Amp_T_f32,TorqueCalc_MtrNm_T_f32
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(float32, AP_CurrCmd_VAR_NOINIT) CalcTorque(VAR(float32, AUTOMATIC) CosDelta_Cnt_T_f32,
                                                       VAR(float32, AUTOMATIC) SinDelta_Cnt_T_f32,
                                                       P2VAR(float32, AUTOMATIC, AUTOMATIC) IdMax_Amp_T_f32)
{
 ...
 * Description: Locate Torque Extremes
 * Inputs:      MtrTrqCmd_MtrNm_T_f32
 * Outputs:     IdMax_Amp_T_f32, PhsAdvPeak_Rad_T_f32,
 *              LimitedMRFMtrTrqCmd_MtrNm_T_f32
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(float32, AP_CurrCmd_VAR_NOINIT) LocateTrqExtremes(VAR(float32, AUTOMATIC) MtrTrqCmd_MtrNm_T_f32,
                                                              P2VAR(float32, AUTOMATIC, AUTOMATIC) IdMax_Amp_T_f32,
                                                              P2VAR(float32, AUTOMATIC, AUTOMATIC) PhsAdvPeak_Rad_T_f32)
{
 ...
 * Description: Locate Minimum Im
 * Inputs:      MtrTrqCmd_MtrNm_T_f32
 * Outputs:     IdMin_Amp_T_f32, IqMin_Amp_T_f32, ImSqrMin_AmpSq_T_f32
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(float32, AP_CurrCmd_VAR_NOINIT) LocateMinimumIm(VAR(float32, AUTOMATIC) MtrTrqCmd_MtrNm_T_f32,
                                                            P2VAR(float32, AUTOMATIC, AUTOMATIC) IdMin_Amp_T_f32,
                                                            P2VAR(float32, AUTOMATIC, AUTOMATIC) IqMin_Amp_T_f32)
{
    VAR(float32, AUTOMATIC) IdRef_Amp_T_f32;
 ...
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(void, AP_CurrCmd_VAR_NOINIT) CalLowPassFiltBilinearTerm(VAR(float32, AUTOMATIC) Freq_Hz_T_f32,
                                                                    VAR(float32, AUTOMATIC) TimeCons_Sec_T_f32,
                                                                    P2VAR(LowPassFiltBilinear_Str, AUTOMATIC, AUTOMATIC) LowPassFiltBilinear_T_Str)
{
 ...
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(float32, AP_CurrCmd_VAR_NOINIT) CalLowPassFiltBilinearOut(VAR(float32, AUTOMATIC) Input_Uls_T_f32,
                                                                      P2VAR(LowPassFiltBilinear_Str, AUTOMATIC, AUTOMATIC) LowPassFiltBilinear_T_Str)
{
 ...
 * Outputs:     MtrCurrAngle_Rev_T_f32   -   Output of the AngleWrap
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(float32, AP_CurrCmd_VAR_NOINIT) AngleWrap(VAR(float32, AUTOMATIC) MtrCurrAngle_Rev_T_f32)
{
 ...
 * InOuts:      *IqMin_Amp_T_f32     -    Q axis minimum current
 ...
 * Usage Notes: None 
 ****************************************************************************/
STATIC FUNC(void, AP_CurrCmd_VAR_NOINIT) CalculateIdBoost(P2VAR(float32, AUTOMATIC, AUTOMATIC) IqMin_Amp_T_f32,
                                                          P2VAR(float32, AUTOMATIC, AUTOMATIC) IdMin_Amp_T_f32,
                                                          VAR(float32, AUTOMATIC) LimitedMRFMtrTrqCmd_MtrNm_T_f32,
                                                          VAR(float32, AUTOMATIC) IdMax_Amp_T_f32)
{
