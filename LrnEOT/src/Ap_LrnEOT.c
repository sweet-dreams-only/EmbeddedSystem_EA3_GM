 ...
 *     SW-C Type:  Ap_LrnEOT
 *  Generated at:  Fri Sep 21 15:06:22 2012
 *
 ...
 * 09/21/12  9        Selva      Checkpoints added and mempmap macros corrected		                           6234
 */
/**********************************************************************************************************************
...
STATIC VAR(uint32, AP_LRNEOT_VAR) CcwEOTTimer_mS_M_u32;
STATIC VAR(uint32, AP_LRNEOT_VAR) CwEOTTimer_mS_M_u32;
STATIC VAR(uint32, AP_LRNEOT_VAR) Position1Timer_mS_M_u32;
STATIC VAR(uint32, AP_LRNEOT_VAR) Position2Timer_mS_M_u32;
...
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(boolean, AP_LRNEOT_VAR) ResetLimitReq_Cnt_M_lgc;
 ...
 *********************************************************************************************************************/
	...
	Rte_Call_SystemTime_GetSystemTime_mS_u32(&Position1Timer_mS_M_u32);
	Position2Timer_mS_M_u32 = Position1Timer_mS_M_u32;
	CwEOTTimer_mS_M_u32 = Position1Timer_mS_M_u32;
	CcwEOTTimer_mS_M_u32 = Position1Timer_mS_M_u32;
 ...
 *********************************************************************************************************************/
	...
	VAR(float32, AUTOMATIC) AbsPostLimitTorque_MtrNm_T_f32;
	...
	AbsPostLimitTorque_MtrNm_T_f32 = Abs_f32_m(PostLimitTorque_MtrNm_T_f32);
	
	
	
	/*** Reset EOT Limits ***/
	
	if( (ResetLimitReq_Cnt_M_lgc == TRUE) ||
	...
	else
	{
		...
		{
			Rte_Call_SystemTime_GetSystemTime_mS_u32(&CwEOTTimer_mS_M_u32);
		}
		else
		{
			Rte_Call_SystemTime_DtrmnElapsedTime_mS_u16(CwEOTTimer_mS_M_u32, &ElapsedTime_mS_T_u16);
		...
		if( (EOTFound_Cnt_T_lgc == FALSE) ||
			(HandwheelPosition_HwDeg_T_f32 > -k_MinRackTrvl_HwDeg_f32) )
		{
			Rte_Call_SystemTime_GetSystemTime_mS_u32(&CcwEOTTimer_mS_M_u32);
		}
		else
		{
			Rte_Call_SystemTime_DtrmnElapsedTime_mS_u16(CcwEOTTimer_mS_M_u32, &ElapsedTime_mS_T_u16);
		...
		Rte_Call_LearnedEOTData_SetRamBlockStatus(TRUE);
	}
...
STATIC FUNC(void, RTE_AP_LRNEOT_APPL_CODE) ResetEOT(void)
{
	...
	if (TRUE == ResetLimitReq_Cnt_M_lgc)
	{
		ResetLimitReq_Cnt_M_lgc = FALSE;
		Rte_Call_LearnedEOTData_WriteBlock(NULL_PTR);
	}
