 ...
 *     Workspace:  C:/SynergyWorkspace/WorkingProjects/AssistFirewall-gzkys7/AssistFirewall/autosar
 *     SW-C Type:  Ap_AssistFirewall
 *  Generated at:  Thu Jan 15 11:13:04 2015
 *
 ...
 * 15/01/15	 14		 SB		   Limit Output to the defined range and updated to v009 of SF34					 12554
 */
/**********************************************************************************************************************
...
/* PRQA S 1800 EOF 
* MISRA-C: 2004 Rule 10.1: This deviation is required for library macros.  The rule is suppressed for the entire file */
/* PRQA S 4393 EOF 
...
#define D_ASSTFWACTIVELOLMT_ULS_F32		(0.0F)
#define D_ASSTFWACTIVEHILMT_ULS_F32		(1.0F)

#define ASSISTFIREWALL_START_SEC_VAR_CLEARED_32
#include "MemMap.h" /* PRQA S 5087 */
STATIC volatile VAR(float32, ASSISTFIREWALL_VAR) AssistFirewall_AsstFWUprBound_MtrNm_D_f32;/* PRQA S 3218 */
STATIC volatile VAR(float32, ASSISTFIREWALL_VAR) AssistFirewall_AsstFWLwrBound_MtrNm_D_f32;/* PRQA S 3218 */
STATIC volatile VAR(float32, ASSISTFIREWALL_VAR) AssistFirewall_AsstFWSumInput_MtrNm_D_f32;/* PRQA S 3218 */
STATIC volatile VAR(float32, ASSISTFIREWALL_VAR) AssistFirewall_AsstFWLowFreqInput_MtrNm_D_f32;/* PRQA S 3218 */
STATIC volatile VAR(float32, ASSISTFIREWALL_VAR) AssistFirewall_AsstFWLowFreqLimited_MtrNm_D_f32;/* PRQA S 3218 */
STATIC volatile VAR(float32, ASSISTFIREWALL_VAR) AssistFirewall_AsstFWActiveRaw_Uls_D_f32;/* PRQA S 3218 */
STATIC volatile VAR(float32, ASSISTFIREWALL_VAR) AssistFirewall_AsstFWUprBoundFilt_MtrNm_D_f32;/* PRQA S 3218 */
STATIC volatile VAR(float32, ASSISTFIREWALL_VAR) AssistFirewall_AsstFWLwrBoundFilt_MtrNm_D_f32;/* PRQA S 3218 */
STATIC VAR(float32, ASSISTFIREWALL_VAR) AssistFirewall_CombAsstSV_MtrNm_M_f32;/* PRQA S 3218 */
#define ASSISTFIREWALL_STOP_SEC_VAR_CLEARED_32
#include "MemMap.h" /* PRQA S 5087 */

#define ASSISTFIREWALL_START_SEC_VAR_CLEARED_16
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(uint16,  ASSISTFIREWALL_VAR) AssistFirewall_ActiveRawAcc_Cnt_M_u16;/* PRQA S 3218 */
#define ASSISTFIREWALL_STOP_SEC_VAR_CLEARED_16
#include "MemMap.h" /* PRQA S 5087 */

#define ASSISTFIREWALL_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(LPF32KSV_Str, ASSISTFIREWALL_VAR) AssistFirewall_UprBoundKSV_M_str;
STATIC VAR(LPF32KSV_Str, ASSISTFIREWALL_VAR) AssistFirewall_LwrBoundKSV_M_str;
STATIC VAR(HPF32KSV_Str, ASSISTFIREWALL_VAR) AssistFirewall_HiFreqKSV_M_str;
STATIC VAR(LPF32KSV_Str, ASSISTFIREWALL_VAR) AssistFirewall_ActiveKSV_M_str;
#define ASSISTFIREWALL_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h" /* PRQA S 5087 */

#define ASSISTFIREWALL_START_SEC_VAR_CLEARED_BOOLEAN	
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(boolean, ASSISTFIREWALL_VAR) AssistFirewall_PNCountStatus_Cnt_M_lgc;/* PRQA S 3218 */
STATIC volatile VAR(boolean, ASSISTFIREWALL_VAR) AssistFirewall_AsstFWOverBound_Cnt_D_lgc;/* PRQA S 3218 */
STATIC VAR(boolean, ASSISTFIREWALL_VAR) AssistFirewall_AsstReducedPerfSV_Cnt_M_lgc;/* PRQA S 3218 */
 ...
 *********************************************************************************************************************/
	...
	LPF_KUpdate_f32_m(k_AsstFWFiltKn_Hz_f32, D_2MS_SEC_F32, &AssistFirewall_UprBoundKSV_M_str);
	LPF_KUpdate_f32_m(k_AsstFWFiltKn_Hz_f32, D_2MS_SEC_F32, &AssistFirewall_LwrBoundKSV_M_str);
	HPF_KUpdate_f32_m(k_AsstFWFiltKn_Hz_f32, D_2MS_SEC_F32, &AssistFirewall_HiFreqKSV_M_str);
	LPF_KUpdate_f32_m(k_AsstFWFWActiveLPF_Hz_f32, D_2MS_SEC_F32, &AssistFirewall_ActiveKSV_M_str);
 ...
 *********************************************************************************************************************/
	...
	HiFreqInput_MtrNm_T_f32 = HPF_OpUpdate_f32_m(SumInput_MtrNm_T_f32, &AssistFirewall_HiFreqKSV_M_str);
	...
	{
		AssistFirewall_CombAsstSV_MtrNm_M_f32 = SumInput_MtrNm_T_f32;
	...
	else
	{
		...
		UprBoundFilt_MtrNm_T_f32 = LPF_OpUpdate_f32_m(UprBound_MtrNm_T_f32, &AssistFirewall_UprBoundKSV_M_str);
		...
		LwrBoundFilt_MtrNm_T_f32 = LPF_OpUpdate_f32_m(LwrBound_MtrNm_T_f32, &AssistFirewall_LwrBoundKSV_M_str);
			...
			(LowFreqInput_MtrNm_T_f32 > UprBoundFilt_MtrNm_T_f32) )
		{
			...
			AssistFirewall_AsstFWOverBound_Cnt_D_lgc = TRUE;
			AssistFirewall_ActiveRawAcc_Cnt_M_u16 = DiagPStep_m(AssistFirewall_ActiveRawAcc_Cnt_M_u16, AsstFWPstepNstep_Cnt_T_str);
		...
		else
		{
			...
			AssistFirewall_AsstFWOverBound_Cnt_D_lgc = FALSE;
			AssistFirewall_ActiveRawAcc_Cnt_M_u16 = DiagNStep_m(AssistFirewall_ActiveRawAcc_Cnt_M_u16, AsstFWPstepNstep_Cnt_T_str);
			(void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_AssistFWReached, 0x01U, NTC_STATUS_PASSED);

		}
		
		if( AssistFirewall_ActiveRawAcc_Cnt_M_u16 >= t_AsstFWPstepNstepThresh_Cnt_u16[1] )
		{
			AssistFirewall_PNCountStatus_Cnt_M_lgc = TRUE;
		}
		else if( AssistFirewall_ActiveRawAcc_Cnt_M_u16 > t_AsstFWPstepNstepThresh_Cnt_u16[0] )
		{
			/* do nothing */
		}
		else
		{
			AssistFirewall_PNCountStatus_Cnt_M_lgc = FALSE;
		}
		
		if(((Abs_f32_m(SumInput_MtrNm_T_f32 - AssistFirewall_CombAsstSV_MtrNm_M_f32) > k_RestoreThresh_MtrNm_f32) && (AssistFirewall_AsstReducedPerfSV_Cnt_M_lgc == TRUE)) || (TRUE == AssistFirewall_PNCountStatus_Cnt_M_lgc))
		{
			AssistFirewall_CombAsstSV_MtrNm_M_f32 = DefltAsst_MtrNm_T_f32;
		...
		{
			AssistFirewall_CombAsstSV_MtrNm_M_f32 = HiFreqInput_MtrNm_T_f32 + LowFreqLimited_MtrNm_T_f32;
			AsstFWActiveRaw_Uls_T_f32 = AsstFWOverBound_Cnt_T_f32;
			AssistFirewall_AsstReducedPerfSV_Cnt_M_lgc = FALSE;
			(void) Rte_Call_NxtrDiagMgr_SetNTCStatus(NTC_Num_AssistFWFltMode, 0x01U, NTC_STATUS_PASSED);

		}
		
		AssistFirewall_CombAsstSV_MtrNm_M_f32 = Limit_m(AssistFirewall_CombAsstSV_MtrNm_M_f32, D_MTRTRQCMDLOLMT_MTRNM_F32, D_MTRTRQCMDHILMT_MTRNM_F32);
		AsstFWActive_Uls_T_f32 = LPF_OpUpdate_f32_m(AsstFWActiveRaw_Uls_T_f32, &AssistFirewall_ActiveKSV_M_str);
		AsstFWActive_Uls_T_f32 = Limit_m(AsstFWActive_Uls_T_f32, D_ASSTFWACTIVELOLMT_ULS_F32, D_ASSTFWACTIVEHILMT_ULS_F32);


		AssistFirewall_AsstFWUprBound_MtrNm_D_f32 = UprBound_MtrNm_T_f32;
		...
		AssistFirewall_AsstFWLowFreqLimited_MtrNm_D_f32 = LowFreqLimited_MtrNm_T_f32;
